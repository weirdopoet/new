...
export declare function getCookie(req: Request, cookie: string): string | undefined;
export declare function getActiveCookie(req: Request): string | undefined;
/**
 * @internal
 * @param req
 * @returns
 */
export declare function getToken(req: Request): string | undefined;
