import { n as THIRDWEB_AUTH_ACTIVE_ACCOUNT_COOKIE, o as THIRDWEB_AUTH_TOKEN_COOKIE_PREFIX, l as LoginPayloadOutputSchema, q as THIRDWEB_AUTH_DEFAULT_REFRESH_INTERVAL_IN_SECONDS, t as THIRDWEB_AUTH_DEFAULT_TOKEN_DURATION_IN_SECONDS, T as ThirdwebAuth$2 } from '../../dist/auth-9bd95804.browser.esm.js';
import { z } from 'zod';
...
function ThirdwebAuth$1(cfg) {
  const ctx = {
    ...cfg,
    auth: new ThirdwebAuth$2(cfg.wallet, cfg.domain, cfg.thirdwebAuthOptions)
  };
