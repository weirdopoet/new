...
import { UserWallet, checkClientIdOrSecretKey, fetchCurrencyMetadata, fetchCurrencyValue, getCachedAbiForContract, ListingType, ThirdwebSDK as ThirdwebSDK$1, getBuyWithCryptoHistory, getBuyWithCryptoQuote, getBuyWithCryptoStatus } from '@thirdweb-dev/sdk';
...
function useBuyWithCryptoStatus(params) {
  const [refetchInterval, setRefetchInterval] = useState(DEFAULT_POLL_INTERVAL);
  return useQuery({
