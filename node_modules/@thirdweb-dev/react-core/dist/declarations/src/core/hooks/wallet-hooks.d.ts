import type { BloctoWallet, Coin98Wallet, CoinbaseWallet, CoreWallet, CryptoDefiWallet, EmbeddedWallet, FrameWallet, ImTokenWallet, LocalWallet, MagicEdenWallet, MagicLink, MetaMaskWallet, OKXWallet, OneKeyWallet, PaperWallet, PhantomWallet, RabbyWallet, RainbowWallet, SafeWallet, SmartWallet, TokenBoundSmartWallet, TrustWallet, WalletConnect, XDEFIWallet, walletIds } from "@thirdweb-dev/wallets";
 ...
 * @walletConnection
 */
export declare function useConnectionStatus(): import("../providers/thirdweb-wallet-provider").ConnectionStatus;
/**
 ...
 * @walletConnection
 */
export declare function useSetConnectionStatus(): (status: import("../providers/thirdweb-wallet-provider").ConnectionStatus) => void;
/**
