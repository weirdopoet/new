 ...
 * @marketplace
 */
export declare function useListing(contract: RequiredParam<Marketplace>, listingId: RequiredParam<BigNumberish>): UseQueryResult<AuctionListing | DirectListing, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useDirectListing(contract: RequiredParam<MarketplaceV3>, listingId: RequiredParam<BigNumberish>): UseQueryResult<import("@thirdweb-dev/sdk").DirectListingV3, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useEnglishAuction(contract: RequiredParam<MarketplaceV3>, auctionId: RequiredParam<BigNumberish>): UseQueryResult<import("@thirdweb-dev/sdk").EnglishAuction, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useListings(contract: RequiredParam<Marketplace>, filter?: MarketplaceFilter): UseQueryResult<(AuctionListing | DirectListing)[], unknown>;
/**
 ...
 * @marketplace
 */
export declare function useDirectListings(contract: RequiredParam<MarketplaceV3>, filter?: MarketplaceFilter): UseQueryResult<import("@thirdweb-dev/sdk").DirectListingV3[], unknown>;
/**
 ...
 * @marketplace
 */
export declare function useValidDirectListings(contract: RequiredParam<MarketplaceV3>, filter?: MarketplaceFilter): UseQueryResult<import("@thirdweb-dev/sdk").DirectListingV3[], unknown>;
/**
 ...
 * @marketplace
 */
export declare function useEnglishAuctions(contract: RequiredParam<MarketplaceV3>, filter?: MarketplaceFilter): UseQueryResult<import("@thirdweb-dev/sdk").EnglishAuction[], unknown>;
/**
 ...
 * @marketplace
 */
export declare function useValidEnglishAuctions(contract: RequiredParam<MarketplaceV3>, filter?: MarketplaceFilter): UseQueryResult<import("@thirdweb-dev/sdk").EnglishAuction[], unknown>;
/**
 ...
 * @marketplace
 */
export declare function useListingsCount(contract: RequiredParam<Marketplace>): UseQueryResult<BigNumber, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useDirectListingsCount(contract: RequiredParam<MarketplaceV3>): UseQueryResult<BigNumber, unknown>;
/**
 * Hook to get the total number of direct listings on a [Marketplace V3](https://thirdweb.com/thirdweb.eth/MarketplaceV3) contract.
 *
 * __This hook is only for [Marketplace V3](https://thirdweb.com/thirdweb.eth/MarketplaceV3) contracts.__
 ...
 * @marketplace
 */
export declare function useEnglishAuctionsCount(contract: RequiredParam<MarketplaceV3>): UseQueryResult<BigNumber, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useActiveListings(contract: RequiredParam<Marketplace>, filter?: MarketplaceFilter): UseQueryResult<(AuctionListing | DirectListing)[], unknown>;
/**
 ...
 * @marketplace
 */
export declare function useWinningBid(contract: RequiredParam<Marketplace>, listingId: RequiredParam<BigNumberish>): UseQueryResult<import("@thirdweb-dev/sdk").Offer | undefined, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useEnglishAuctionWinningBid(contract: RequiredParam<MarketplaceV3>, auctionId: RequiredParam<BigNumberish>): UseQueryResult<import("@thirdweb-dev/sdk").Bid | undefined, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useAuctionWinner(contract: RequiredParam<Marketplace | MarketplaceV3>, listingId: RequiredParam<BigNumberish>): UseQueryResult<string, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useBidBuffer(contract: RequiredParam<Marketplace | MarketplaceV3>, listingId?: RequiredParam<BigNumberish>): UseQueryResult<BigNumber, unknown>;
/**
 ...
 * @marketplace
 */
export declare function useMinimumNextBid(contract: RequiredParam<Marketplace | MarketplaceV3>, listingId: RequiredParam<BigNumberish>): UseQueryResult<{
    symbol: string;
    value: BigNumber;
    name: string;
    decimals: number;
 ...
 * @twfeature DirectListings
 */
export declare function useCreateDirectListingBatch<TMarketplaceV3 extends MarketplaceV3>(contract: RequiredParam<TMarketplaceV3>): UseMutationResult<import("@thirdweb-dev/sdk").TransactionResultWithId[], unknown, {
    pricePerToken: string | number;
    tokenId: (string | number | bigint | BigNumber) & (string | number | bigint | BigNumber | undefined);
    assetContractAddress: string;
    quantity?: string | number | bigint | BigNumber | undefined;
