...
function useBuyWithCryptoHistory(params, queryParams) {
  return reactQuery.useQuery({
    ...
    queryFn: () => {
      ...
      return sdk.getBuyWithCryptoHistory(params);
    },
    enabled: !!params
  });
}
...
function useBuyWithCryptoQuote(params, queryParams) {
  return reactQuery.useQuery({
    ...
    queryFn: () => {
      ...
      return sdk.getBuyWithCryptoQuote(params);
    },
    enabled: !!params
  });
}
...
function useBuyWithCryptoStatus(params) {
  const [refetchInterval, setRefetchInterval] = react.useState(DEFAULT_POLL_INTERVAL);
  return reactQuery.useQuery({
    ...
    queryFn: async () => {
      ...
      const swapStatus_ = await sdk.getBuyWithCryptoStatus({
        ...params,
