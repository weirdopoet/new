import { LockOpen1Icon, EyeClosedIcon, EyeOpenIcon, CheckIcon, PinBottomIcon, CopyIcon as CopyIcon$1, Cross2Icon, CrossCircledIcon, MagnifyingGlassIcon, ChevronDownIcon, CheckCircledIcon, ClockIcon, ArrowRightIcon, PaperPlaneIcon, PlusIcon, TextAlignJustifyIcon, ShuffleIcon, ExitIcon, ChevronRightIcon, EnterIcon, ExternalLinkIcon, ReloadIcon } from '@radix-ui/react-icons';
import { b as StyledButton, u as useCustomTheme, f as fontSize, C as Container, I as Img, M as ModalHeader, B as Button, s as spacing, i as iconSize, S as StyledDiv, c as fadeInAnimation, L as Line, e as InputButton, g as IconButton, a as ModalDescription, h as ScreenBottomContainer, j as StyledP, m as media, r as radius, k as shadow, n as noScrollBar, o as CustomThemeProvider, p as ModalTitle, q as Skeleton, t as StyledUl, v as StyledAnchor } from './basic-ed22e83a.browser.esm.js';
import { u as useTWLocale, f as TextDivider, S as Spacer, g as useScreenContext, M as ModalConfigCtx, T as Text, a as Spinner, I as InputContainer, h as Input, r as reservedScreens, L as Label, m as modalCloseFadeOutDuration, w as wideModalMaxHeight, j as modalMaxWidthCompact, k as modalMaxWidthWide, l as compactModalMaxHeight, o as onModalUnmount, n as Link, c as useSetIsWalletModalOpen, p as SetModalConfigCtx, q as canFitWideModal, s as useSetupScreen, b as useIsWalletModalOpen, t as ScreenSetupContext, v as defaultTheme, W as WalletUIStatesProvider, x as ThirdwebLocaleContext, e as en } from './formElements-024644ee.browser.esm.js';
  ...
  return /*#__PURE__*/jsxs(Container, {
    children: [/*#__PURE__*/jsx(Container, {
      ...
      children: [props.showTabs !== false && /*#__PURE__*/jsxs(Fragment, {
        ...
        y: "xxs"
      }), allChains.length > 10 && /*#__PURE__*/jsxs(Fragment, {
        children: [/*#__PURE__*/jsx(Container, {
          px: "lg",
...
const NetworkTab = props => {
  ...
  return /*#__PURE__*/jsx(Container, {
    ...
    children: filteredChainSections.length > 0 ? /*#__PURE__*/jsx(Container, {
      flex: "column",
      gap: "lg",
      children: filteredChainSections.map(section => {
        return /*#__PURE__*/jsxs("div", {
          children: [showSectionLabel && /*#__PURE__*/jsxs(Fragment, {
...
const ConnectedWalletDetails = props => {
  ...
  let content = /*#__PURE__*/jsxs("div", {
    children: [/*#__PURE__*/jsx(Spacer, {
      ...
      children: [/*#__PURE__*/jsxs(Container, {
        ...
        }), activeWallet?.walletId === walletIds.embeddedWallet && /*#__PURE__*/jsx("div", {
          children: /*#__PURE__*/jsxs(MenuButton, {
            onClick: () => {
  ...
  if (screen === "network-switcher") {
    ...
    content = /*#__PURE__*/jsx(ExportPrivateKey, {
      theme: props.theme,
      walletInstance: activeWallet,
      onBack: () => {
        setScreen("main");
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-8dca7686.browser.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-8dca7686.browser.esm.js').then(function (n) { return n.u; });
...
function useMetamask() {
  ...
  return useCallback(async options => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-8dca7686.browser.esm.js').then(function (n) { return n.n; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-8dca7686.browser.esm.js').then(function (n) { return n.l; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-8cc5e47c.browser.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-d2f9a4b2.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-7f7a98bb.browser.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-8dca7686.browser.esm.js').then(function (n) { return n.q; });
