...
var formElements = require('./formElements-c52060bf.cjs.prod.js');
var basic = require('./basic-00d2f774.cjs.prod.js');
...
`;
const LogoContainer = /* @__PURE__ */basic.StyledDiv(() => {
  ...
  return {
    ...
    svg: {
      ...
      animation: `${basic.fadeInAnimation} 400ms ease`
    },
    img: {
      zIndex: 100
    },
...
const IconContainer = /* @__PURE__ */basic.StyledDiv({
  position: "absolute",
  top: "50%",
  left: "50%",
...
const QRCodeContainer = /* @__PURE__ */basic.StyledDiv(() => {
  const theme = basic.useCustomTheme();
  return {
    animation: `${basic.fadeInAnimation} 600ms ease`,
...
`;
const QRPlaceholder = /* @__PURE__ */basic.StyledDiv(() => {
  const theme = basic.useCustomTheme();
  return {
...
const GetStartedScreen = _ref => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
      ...
      }), showScreen === "base" && /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
        expand: true,
        flex: "column",
        children: [header || /*#__PURE__*/jsxRuntime.jsx(basic.ModalHeader, {
          onBack: handleBack,
          title: walletName
        }), /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
          y: "xl"
...
const ButtonLink = /* @__PURE__ */basic.StyledButton(() => {
  const theme = basic.useCustomTheme();
  return {
    all: "unset",
    textDecoration: "none",
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(basic.Container, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(QRCode, {
          ...
          balance: true,
          style: {
            paddingInline: basic.spacing.lg
          },
...
const WalletConnectScan = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(basic.Container, {
      ...
      px: "lg",
      expand: true,
      children: isWCModalOpen ? /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
        style: {
          minHeight: "300px"
        },
        flex: "column",
...
const WalletSelector = props => {
  ...
  const continueAsGuest = localWalletConfig && /*#__PURE__*/jsxRuntime.jsx(basic.Button, {
    fullWidth: true,
  ...
  const twTitle = /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
    gap: "xxs",
    center: "y",
    flex: "row",
    ...
    }) : modalConfig.titleIconUrl === "" ? null : /*#__PURE__*/jsxRuntime.jsx(basic.Img, {
  ...
  const connectAWallet = /*#__PURE__*/jsxRuntime.jsxs(basic.Button, {
    fullWidth: true,
    variant: "outline",
    style: {
      display: "flex",
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(basic.Container, {
      flex: "row",
      gap: "xxs",
      children: eoaWallets.slice(0, 2).map(w => /*#__PURE__*/jsxRuntime.jsx(basic.Img, {
        width: basic.iconSize.sm,
        height: basic.iconSize.sm,
        src: w.meta.iconURL
      }, w.id))
  ...
  const newToWallets = /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
    flex: "row",
    style: {
  ...
  if (!isCompact) {
    ...
    if (continueAsGuest) {
      bottomSection = /*#__PURE__*/jsxRuntime.jsx(basic.ScreenBottomContainer, {
  ...
  // compact
    ...
    if (socialWallets.length === 0) {
      ...
      bottomSection = /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(basic.Line, {}), /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
          flex: "column",
          p: "lg",
          gap: "lg",
          children: [newToWallets, continueAsGuest]
        }), !continueAsGuest && /*#__PURE__*/jsxRuntime.jsx(basic.Line, {}), tos && /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
          px: "md",
          style: {
            paddingBottom: basic.spacing.md,
            paddingTop: continueAsGuest ? 0 : basic.spacing.md
          },
          children: tos
        })]
      });
    ...
    // social logins
      ...
      if (!isWalletGroupExpanded) {
        topSection = /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
          px: "xs",
        ...
        if (eoaWallets.length === 0) {
          bottomSection = tos || continueAsGuest ? /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
              y: "md"
            }), /*#__PURE__*/jsxRuntime.jsx(basic.Line, {}), continueAsGuest && /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
              p: "lg",
              children: [" ", continueAsGuest]
            }), tos && /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
              p: "md",
              children: [" ", tos, " "]
            })]
          }) : /*#__PURE__*/jsxRuntime.jsx(formElements.Spacer, {
        ...
        // social login + eoa wallets
          ...
          if (eoaWallets.length > 1) {
            bottomSection = /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
              flex: "column",
              gap: "sm",
              children: [/*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
                px: "lg",
          ...
          // social login + single eoa wallet
            ...
            bottomSection = /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
              ...
              }), continueAsGuest && /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
                flex: "column",
                px: "lg",
                gap: "lg",
                children: continueAsGuest
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
    ...
    animate: "fadein",
    fullHeight: true,
    children: [!modalConfig.isEmbed && /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
      p: "lg",
      style: {
        paddingBottom: basic.spacing.md
      },
      children: isWalletGroupExpanded ? /*#__PURE__*/jsxRuntime.jsx(basic.ModalHeader, {
        title: twTitle,
        onBack: () => {
      ...
      style: modalConfig.isEmbed ? {
        paddingTop: basic.spacing.lg
      } : {
        paddingTop: "2px"
      },
      children: [modalConfig.isEmbed && isWalletGroupExpanded && /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
        flex: "row",
        center: "y",
        style: {
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs(basic.IconButton, {
          onClick: () => {
            setIsWalletGroupExpanded(false);
          },
          style: {
            gap: basic.spacing.xxs,
            transform: `translateX(-${basic.spacing.xs})`,
            paddingBlock: basic.spacing.xxs,
      ...
      children: [bottomSection, isCompact && modalConfig.showThirdwebBranding !== false && /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
        py: "md",
...
const WalletList = /* @__PURE__ */basic.StyledUl({
  all: "unset",
  listStyleType: "none",
  display: "flex",
...
const WalletButton = /* @__PURE__ */basic.StyledButton(() => {
  const theme = basic.useCustomTheme();
  return {
    all: "unset",
    display: "flex",
    ...
    position: "relative",
    borderRadius: basic.radius.md,
    padding: `${basic.spacing.xs} ${basic.spacing.xs}`,
    "&:hover": {
