...
const MagicUI = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(basic.Container, {
    ...
    children: [props.oauthProviders && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: props.oauthProviders.length > 1 ? /*#__PURE__*/jsxRuntime.jsx(basic.Container, {
        gap: "md",
        flex: "row",
        style: {
...
const SocialButtonLarge = /* @__PURE__ */styled__default["default"](basic.Button)(() => {
...
const SocialIconButton = /* @__PURE__ */styled__default["default"](basic.IconButton)(() => {
  const theme = basic.useCustomTheme();
  return {
