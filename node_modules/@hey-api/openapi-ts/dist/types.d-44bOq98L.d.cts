...
> &
  Pick<UserConfig$o, 'base' | 'name' | 'request'> & {
    ...
    logs: Extract<Required<UserConfig$o['logs']>, object>;
    output: Extract<UserConfig$o['output'], object>;
    /**
     * Customize how the input is parsed and transformed before it's passed to
     * plugins.
     */
...
type Config$a = Plugin.Name<'@angular/common'> & {
  /**
   * Should the exports from the generated files be re-exported in the index
   * barrel file?
   *
...
type AngularCommonPlugin = DefinePlugin<UserConfig$n, Config$a>;
...
type HeyApiClientAxiosPlugin = DefinePlugin<UserConfig$m>;
...
type HeyApiClientFetchPlugin = DefinePlugin<UserConfig$l>;
...
type UserConfig$i = Plugin.Name<'@hey-api/client-angular'> &
  Client.Config & {
    /**
     * Throw an error instead of returning it in the response?
     *
...
type HeyApiClientAngularPlugin = DefinePlugin<UserConfig$i>;

type UserConfig$h = Plugin.Name<'legacy/angular'> &
  Pick<Client.Config, 'output'>;

type HeyApiClientLegacyAngularPlugin = DefinePlugin<UserConfig$h>;

type UserConfig$g = Plugin.Name<'legacy/axios'> &
  Pick<Client.Config, 'output'>;

type HeyApiClientLegacyAxiosPlugin = DefinePlugin<UserConfig$g>;

type UserConfig$f = Plugin.Name<'legacy/fetch'> &
  Pick<Client.Config, 'output'>;

type HeyApiClientLegacyFetchPlugin = DefinePlugin<UserConfig$f>;

type UserConfig$e = Plugin.Name<'legacy/node'> &
  Pick<Client.Config, 'output'>;

type HeyApiClientLegacyNodePlugin = DefinePlugin<UserConfig$e>;

type UserConfig$d = Plugin.Name<'legacy/xhr'> &
  Pick<Client.Config, 'output'>;
...
type Config$9 = Plugin.Name<'@hey-api/sdk'> & {
  /**
   * Group operation methods into classes? When enabled, you can select which
   * classes to export with `sdk.include` and/or transform their names with
   * `sdk.classNameBuilder`.
...
type HeyApiSdkPlugin = DefinePlugin<UserConfig$b, Config$9>;
...
type UserConfig$a = Plugin.Name<'@hey-api/transformers'> & {
  /**
...
type HeyApiTypeScriptPlugin = DefinePlugin<UserConfig$9, Config$8, Api$2>;
...
type Config$7 = Plugin.Name<'@pinia/colada'> &
  Plugin.Hooks & {
    /**
     * The casing convention to use for generated names.
     *
    ...
    mutationOptions: {
       ...
       */
      meta:
        | ((operation: IR$1.OperationObject) => Record<string, unknown>)
        | undefined;
      /**
       * Custom naming pattern for generated mutation options names. The name variable is
       * obtained from the SDK function name.
...
declare class IRContext<Spec extends Record<string, any> = any> {
     ...
     */
    file({ id }: Pick<IR$1.ContextFile, 'id'>): GeneratedFile | undefined;
    /**
