...
import { PUBLISHED_PRIVATE_KEY, singletonFactoryAbi, singletonFactoryBytecode, ZKSYNC_SINGLETON_FACTORY, } from "../../../utils/any-evm/zksync/constants.js";
 ...
 * @internal
 */
export async function zkDeployCreate2Factory(options) {
    ...
    if (!PUBLISHED_PRIVATE_KEY) {
        throw new Error(`Unable to deploy create2 factory on chain ${options.chain.id} - please contact us via https://thirdweb.com/support to enable this chain`);
    }
