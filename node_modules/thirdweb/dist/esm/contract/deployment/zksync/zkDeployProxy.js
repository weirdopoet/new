...
import { twProxyAbi, twProxyBytecode, } from "../../../utils/any-evm/zksync/constants.js";
 ...
 * @internal
 */
export async function zkDeployProxy(options) {
    // TODO ensure implementation is deployed
    const implementationAddress = await resolvePromisedValue(options.initializeTransaction.to);
