...
import { KNOWN_CODES_STORAGE, singletonFactoryAbi, } from "../../../utils/any-evm/zksync/constants.js";
import { isContractDeployed } from "../../../utils/bytecode/is-contract-deployed.js";
import { ensureBytecodePrefix } from "../../../utils/bytecode/prefix.js";
import { isHex, uint8ArrayToHex, } from "../../../utils/encoding/hex.js";
 ...
 * @internal
 */
export async function zkDeployContractDeterministic(options) {
    const constructorAbi = options.abi.find((x) => "type" in x && x.type === "constructor") || { inputs: [] };
    const encodedArgs = encodeAbiParameters(constructorAbi.inputs, normalizeFunctionParams(constructorAbi, options.params));
    ...
    const deployed = await isContractDeployed(getContract({
