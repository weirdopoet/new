import { DEFAULT_LOGIN_PAYLOAD_EXPIRATION, DEFAULT_LOGIN_STATEMENT, DEFAULT_LOGIN_VERSION, } from "./constants.js";
/**
 ...
 * @internal
 */
export function generateLoginPayload(options) {
    return async ({ address, chainId, }) => {
        ...
        return {
            ...
            nonce: await (options.login?.nonce?.generate ||
                (() => import("../../utils/random.js").then(({ randomBytesHex }) => randomBytesHex())))(),
