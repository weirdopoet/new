...
export async function getWalletPrivateKeyFromShares(shares) {
 ...
 */
export async function getShares({ client, authShare, deviceShare, recoveryShare, storage, }) {
    const queryParams = {};
...
export async function setUpShareForNewDevice({ recoveryCode, client, storage, }) {
