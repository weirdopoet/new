...
import { DEVICE_SHARE_LOCAL_STORAGE_NAME, WALLET_USER_DETAILS_LOCAL_STORAGE_NAME, WALLET_USER_ID_LOCAL_STORAGE_NAME, } from "../../../core/constants/settings.js";
...
export async function setWallerUserDetails({ clientId, userId, email, }) {
    ...
    name, stringify({ email: newEmail, userId }));
}
