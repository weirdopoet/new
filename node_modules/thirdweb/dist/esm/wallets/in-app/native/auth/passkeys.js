...
import { base64ToString, base64ToUint8Array, base64UrlToBase64, uint8ArrayToBase64, } from "../../../../utils/uint8-array.js";
import { ClientScopedStorage } from "../../core/authentication/client-scoped-storage.js";
export class PasskeyNativeClient {
    isAvailable() {
    ...
    async register(args) {
        ...
        const clientDataB64 = base64UrlToBase64(parsedResult.response.clientDataJSON);
