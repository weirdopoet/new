...
export const FN_SELECTOR = "0xe05688fe";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
export function isAddExtensionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAddExtensionParams(options) {
 ...
 * ```
 */
export function encodeAddExtension(options) {
 ...
 * ```
 */
export function addExtension(options) {
