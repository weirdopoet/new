...
export const FN_SELECTOR = "0xf2dc691d";
const FN_INPUTS = [
    {
        name: "moduleTypeId",
        type: "uint256",
 ...
 * ```
 */
export function isSupportsModuleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSupportsModuleParams(options) {
 ...
 * ```
 */
export function encodeSupportsModule(options) {
 ...
 * ```
 */
export function decodeSupportsModuleResult(result) {
 ...
 * ```
 */
export async function supportsModule(options) {
    return readContract({
