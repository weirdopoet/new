...
export const FN_SELECTOR = "0xd03c7914";
const FN_INPUTS = [
    {
        name: "encodedMode",
        type: "bytes32",
 ...
 * ```
 */
export function isSupportsExecutionModeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSupportsExecutionModeParams(options) {
 ...
 * ```
 */
export function encodeSupportsExecutionMode(options) {
 ...
 * ```
 */
export function decodeSupportsExecutionModeResult(result) {
 ...
 * ```
 */
export async function supportsExecutionMode(options) {
    return readContract({
