...
export const FN_SELECTOR = "0x112d3a7d";
const FN_INPUTS = [
    {
        name: "moduleTypeId",
        type: "uint256",
 ...
 * ```
 */
export function isIsModuleInstalledSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsModuleInstalledParams(options) {
 ...
 * ```
 */
export function encodeIsModuleInstalled(options) {
 ...
 * ```
 */
export function decodeIsModuleInstalledResult(result) {
 ...
 * ```
 */
export async function isModuleInstalled(options) {
    return readContract({
