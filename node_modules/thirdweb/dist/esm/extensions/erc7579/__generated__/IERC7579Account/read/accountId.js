...
export const FN_SELECTOR = "0x9cfd7cff";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isAccountIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeAccountIdResult(result) {
 ...
 * ```
 */
export async function accountId(options) {
    return readContract({
