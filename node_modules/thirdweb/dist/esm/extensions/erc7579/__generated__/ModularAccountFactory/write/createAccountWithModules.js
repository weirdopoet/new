...
export const FN_SELECTOR = "0x7c37d0dc";
const FN_INPUTS = [
    {
        name: "owner",
        type: "address",
 ...
 * ```
 */
export function isCreateAccountWithModulesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCreateAccountWithModulesParams(options) {
 ...
 * ```
 */
export function encodeCreateAccountWithModules(options) {
 ...
 * ```
 */
export function createAccountWithModules(options) {
