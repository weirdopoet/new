...
export const FN_SELECTOR = "0x5c60da1b";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "result",
 ...
 * ```
 */
export function isImplementationSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeImplementationResult(result) {
 ...
 * ```
 */
export async function implementation(options) {
    return readContract({
