...
export const FN_SELECTOR = "0x3659cfe6";
const FN_INPUTS = [
    {
 ...
 * ```
 */
export function isUpgradeToSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUpgradeToParams(options) {
 ...
 * ```
 */
export function encodeUpgradeTo(options) {
 ...
 * ```
 */
export function upgradeTo(options) {
