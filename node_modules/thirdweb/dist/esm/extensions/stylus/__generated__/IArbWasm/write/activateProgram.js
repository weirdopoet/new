...
export const FN_SELECTOR = "0x58c780c2";
const FN_INPUTS = [
    {
        name: "program",
        type: "address",
 ...
 * ```
 */
export function isActivateProgramSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeActivateProgramParams(options) {
 ...
 * ```
 */
export function encodeActivateProgram(options) {
 ...
 * ```
 */
export function activateProgram(options) {
