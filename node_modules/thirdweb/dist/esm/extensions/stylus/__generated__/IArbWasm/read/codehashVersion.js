...
export const FN_SELECTOR = "0xd70c0ca7";
const FN_INPUTS = [
    {
        name: "codehash",
        type: "bytes32",
 ...
 * ```
 */
export function isCodehashVersionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCodehashVersionParams(options) {
 ...
 * ```
 */
export function encodeCodehashVersion(options) {
 ...
 * ```
 */
export function decodeCodehashVersionResult(result) {
 ...
 * ```
 */
export async function codehashVersion(options) {
    return readContract({
