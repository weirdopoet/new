...
export const FN_SELECTOR = "0xa9a8e4e9";
const FN_INPUTS = [
    {
        name: "bytecode",
        type: "bytes",
 ...
 * ```
 */
export function isDeploySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDeployParams(options) {
 ...
 * ```
 */
export function encodeDeploy(options) {
