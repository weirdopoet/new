...
export function mint(options) {
    return generatedMint({
        asyncParams: async () => {
            ...
            const erc20Value = !isNativeTokenAddress(cc.currency) && cc.pricePerUnit > 0n
                ? {
            ...
            if (cc.allowlistMerkleRoot &&
                ...
                const { fetchProofsForClaimer } = await import("../../../utils/extensions/drops/fetch-proofs-for-claimers.js");
                    ...
                    if (merkleTreeUri) {
                        const allowlistProof = await fetchProofsForClaimer({
                            ...
                            async hashEntry(options) {
                                return keccak256(encodePacked(["address"], [getAddress(options.entry.address)]));
                            },
                            merkleTreeUri,
                            tokenDecimals,
                        });
