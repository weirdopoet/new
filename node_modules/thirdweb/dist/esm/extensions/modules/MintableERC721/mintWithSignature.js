...
import { encodeBytesBeforeMintWithSignatureERC721Params, } from "../__generated__/MintableERC721/encode/encodeBytesBeforeMintWithSignatureERC721.js";
/**
...
export async function generateMintSignature(options) {
    ...
    const batchOfUris = await uploadOrExtractURIs(options.nfts, options.contract.client, Number(nextIdToMint));
