...
export const FN_SELECTOR = "0x33cfcb9f";
const FN_INPUTS = [
    {
        name: "_batchIndex",
        type: "uint256",
 ...
 * ```
 */
export function isSetBaseURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetBaseURIParams(options) {
 ...
 * ```
 */
export function encodeSetBaseURI(options) {
 ...
 * ```
 */
export function setBaseURI(options) {
