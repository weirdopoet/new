...
export const FN_SELECTOR = "0x44ec3c07";
const FN_INPUTS = [
    {
        name: "_tokenId",
        type: "uint256",
 ...
 * ```
 */
export function isGetBatchIndexSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetBatchIndexParams(options) {
 ...
 * ```
 */
export function encodeGetBatchIndex(options) {
 ...
 * ```
 */
export function decodeGetBatchIndexResult(result) {
 ...
 * ```
 */
export async function getBatchIndex(options) {
    return readContract({
