 ...
 * const supported = BatchMetadataERC1155.isEncodeBytesOnInstallSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { BatchMetadataERC1155 } from "thirdweb/modules";
 * const result = BatchMetadataERC1155.decodeEncodeBytesOnInstallResultResult("...");
 * ```
 */
 ...
 * import { BatchMetadataERC1155 } from "thirdweb/modules";
 *
 * const result = await BatchMetadataERC1155.encodeBytesOnInstall({
 *  contract,
 * });
 *
 * ```
