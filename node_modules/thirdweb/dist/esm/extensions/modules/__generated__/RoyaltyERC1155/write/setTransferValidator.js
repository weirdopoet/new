...
export const FN_SELECTOR = "0xa9fc664e";
const FN_INPUTS = [
    {
        name: "validator",
        type: "address",
 ...
 * ```
 */
export function isSetTransferValidatorSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetTransferValidatorParams(options) {
 ...
 * ```
 */
export function encodeSetTransferValidator(options) {
 ...
 * ```
 */
export function setTransferValidator(options) {
