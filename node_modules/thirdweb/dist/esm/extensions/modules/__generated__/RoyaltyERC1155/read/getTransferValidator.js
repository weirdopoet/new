...
export const FN_SELECTOR = "0x098144d4";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "validator",
 ...
 * ```
 */
export function isGetTransferValidatorSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetTransferValidatorResult(result) {
 ...
 * ```
 */
export async function getTransferValidator(options) {
    return readContract({
