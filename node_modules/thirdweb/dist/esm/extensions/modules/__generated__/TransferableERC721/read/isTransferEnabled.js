...
export const FN_SELECTOR = "0xcca5dcb6";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bool",
 ...
 * ```
 */
export function isIsTransferEnabledSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeIsTransferEnabledResult(result) {
