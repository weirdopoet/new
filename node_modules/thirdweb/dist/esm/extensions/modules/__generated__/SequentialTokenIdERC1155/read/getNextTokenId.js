...
export const FN_SELECTOR = "0xcaa0f92a";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isGetNextTokenIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetNextTokenIdResult(result) {
 ...
 * ```
 */
export async function getNextTokenId(options) {
    return readContract({
