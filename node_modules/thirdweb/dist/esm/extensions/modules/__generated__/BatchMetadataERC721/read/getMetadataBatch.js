...
export const FN_SELECTOR = "0xe034558b";
const FN_INPUTS = [
    {
        name: "_batchIndex",
        type: "uint256",
 ...
 * ```
 */
export function isGetMetadataBatchSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetMetadataBatchParams(options) {
 ...
 * ```
 */
export function encodeGetMetadataBatch(options) {
 ...
 * ```
 */
export function decodeGetMetadataBatchResult(result) {
 ...
 * ```
 */
export async function getMetadataBatch(options) {
    return readContract({
