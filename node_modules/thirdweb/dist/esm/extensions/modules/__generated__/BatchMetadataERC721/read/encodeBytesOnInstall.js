 ...
 * const supported = BatchMetadataERC721.isEncodeBytesOnInstallSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { BatchMetadataERC721 } from "thirdweb/modules";
 * const result = BatchMetadataERC721.decodeEncodeBytesOnInstallResultResult("...");
 * ```
 */
 ...
 * import { BatchMetadataERC721 } from "thirdweb/modules";
 *
 * const result = await BatchMetadataERC721.encodeBytesOnInstall({
 *  contract,
 * });
 *
 * ```
