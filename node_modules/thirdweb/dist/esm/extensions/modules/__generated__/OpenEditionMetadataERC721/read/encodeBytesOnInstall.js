...
export const FN_SELECTOR = "0xfec7ff72";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes",
 ...
 * const supported = OpenEditionMetadataERC721.isEncodeBytesOnInstallSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { OpenEditionMetadataERC721 } from "thirdweb/modules";
 * const result = OpenEditionMetadataERC721.decodeEncodeBytesOnInstallResultResult("...");
 * ```
 */
 ...
 * import { OpenEditionMetadataERC721 } from "thirdweb/modules";
 *
 * const result = await OpenEditionMetadataERC721.encodeBytesOnInstall({
 *  contract,
 * });
 *
 * ```
