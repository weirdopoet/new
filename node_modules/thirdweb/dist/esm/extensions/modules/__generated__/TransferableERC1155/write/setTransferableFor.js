...
export const FN_SELECTOR = "0x4c297cbd";
const FN_INPUTS = [
    {
        name: "target",
        type: "address",
 ...
 * ```
 */
export function isSetTransferableForSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetTransferableForParams(options) {
 ...
 * ```
 */
export function encodeSetTransferableFor(options) {
