...
export const FN_SELECTOR = "0x93d79445";
const FN_INPUTS = [
    {
 ...
 *
 * const supported = RoyaltyERC721.isSetDefaultRoyaltyInfoSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { RoyaltyERC721 } from "thirdweb/modules";
 * const result = RoyaltyERC721.encodeSetDefaultRoyaltyInfoParams({
 *  royaltyRecipient: ...,
 *  royaltyBps: ...,
 * });
 * ```
 ...
 * ```ts
 * import { RoyaltyERC721 } from "thirdweb/modules";
 * const result = RoyaltyERC721.encodeSetDefaultRoyaltyInfo({
 *  royaltyRecipient: ...,
 *  royaltyBps: ...,
 * });
 * ```
