...
export const FN_SELECTOR = "0x0d705df6";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetTransferValidationFunctionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetTransferValidationFunctionResult(result) {
 ...
 * ```
 */
export async function getTransferValidationFunction(options) {
    return readContract({
