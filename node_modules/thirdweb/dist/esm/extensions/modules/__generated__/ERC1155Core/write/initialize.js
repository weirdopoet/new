...
export const FN_SELECTOR = "0x62835ade";
const FN_INPUTS = [
    {
        name: "_name",
        type: "string",
 ...
 *
 * const supported = ERC1155Core.isInitializeSupported(["0x..."]);
 * ```
 */
 ...
 * ```ts
 * import { ERC1155Core } from "thirdweb/modules";
 * const result = ERC1155Core.encodeInitializeParams({
 *  name: ...,
 *  symbol: ...,
 *  contractURI: ...,
 *  owner: ...,
 ...
 * ```ts
 * import { ERC1155Core } from "thirdweb/modules";
 * const result = ERC1155Core.encodeInitialize({
 *  name: ...,
 *  symbol: ...,
 *  contractURI: ...,
 *  owner: ...,
 ...
 * import { ERC1155Core } from "thirdweb/modules";
 *
 * const transaction = ERC1155Core.initialize({
 *  contract,
 *  name: ...,
 *  symbol: ...,
 *  contractURI: ...,
