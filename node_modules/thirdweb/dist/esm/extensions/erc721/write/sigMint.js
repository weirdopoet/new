...
import { mintWithSignature as generatedMintWithSignatureV2, } from "../__generated__/ISignatureMintERC721_v2/write/mintWithSignature.js";
/**
...
export async function generateMintSignature(options) {
    ...
    let saleRecipient;
    if (mintRequest.primarySaleRecipient?.length === 0 ||
        !mintRequest.primarySaleRecipient) {
        const { primarySaleRecipient } = await import("../../common/__generated__/IPrimarySale/read/primarySaleRecipient.js");
    ...
    if (mintRequest.royaltyRecipient?.length === 0 ||
        !mintRequest.royaltyRecipient) {
        const { getDefaultRoyaltyInfo } = await import("../../common/__generated__/IRoyalty/read/getDefaultRoyaltyInfo.js");
