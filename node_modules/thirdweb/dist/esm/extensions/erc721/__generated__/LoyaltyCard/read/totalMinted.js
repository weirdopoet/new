...
export const FN_SELECTOR = "0xa2309ff8";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isTotalMintedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeTotalMintedResult(result) {
 ...
 * ```
 */
export async function totalMinted(options) {
    return readContract({
