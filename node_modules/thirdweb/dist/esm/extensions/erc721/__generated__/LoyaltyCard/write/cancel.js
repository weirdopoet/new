...
export const FN_SELECTOR = "0x40e58ee5";
const FN_INPUTS = [
    {
        name: "tokenId",
        type: "uint256",
 ...
 * ```
 */
export function isCancelSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCancelParams(options) {
 ...
 * ```
 */
export function encodeCancel(options) {
