...
export const FN_SELECTOR = "0x20c5429b";
const FN_INPUTS = [
    {
        name: "tokenId",
        type: "uint256",
 ...
 * ```
 */
export function isRevokeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRevokeParams(options) {
 ...
 * ```
 */
export function encodeRevoke(options) {
