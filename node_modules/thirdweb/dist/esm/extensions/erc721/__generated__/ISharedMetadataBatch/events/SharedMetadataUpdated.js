 ...
 * ```
 */
export function sharedMetadataUpdatedEvent(filters = {}) {
    return prepareEvent({
        filters,
        signature: "event SharedMetadataUpdated(bytes32 indexed id, string name, string description, string imageURI, string animationURI)",
    });
}
