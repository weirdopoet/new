...
export const FN_SELECTOR = "0x7647691d";
const FN_INPUTS = [
    {
        name: "_tokenId",
        type: "uint256",
 ...
 * ```
 */
export function isUnwrapSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUnwrapParams(options) {
 ...
 * ```
 */
export function encodeUnwrap(options) {
 ...
 * ```
 */
export function unwrap(options) {
