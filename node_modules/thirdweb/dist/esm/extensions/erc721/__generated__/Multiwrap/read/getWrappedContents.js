...
export const FN_SELECTOR = "0xd5576d26";
const FN_INPUTS = [
    {
        name: "_tokenId",
        type: "uint256",
 ...
 * ```
 */
export function isGetWrappedContentsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetWrappedContentsParams(options) {
 ...
 * ```
 */
export function encodeGetWrappedContents(options) {
 ...
 * ```
 */
export function decodeGetWrappedContentsResult(result) {
 ...
 * ```
 */
export async function getWrappedContents(options) {
    return readContract({
