...
export const FN_SELECTOR = "0x29e471dd";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
export function isWrapSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeWrapParams(options) {
 ...
 * ```
 */
export function encodeWrap(options) {
