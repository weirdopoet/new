...
import { getBaseURICount, isGetBaseURICountSupported, } from "../../__generated__/IBatchMintMetadata/read/getBaseURICount.js";
import { encryptDecrypt, isEncryptDecryptSupported, } from "../../__generated__/IDelayedReveal/read/encryptDecrypt.js";
import { nextTokenIdToMint } from "../../__generated__/IERC721Enumerable/read/nextTokenIdToMint.js";
import { lazyMint as generatedLazyMint, isLazyMintSupported, } from "../../__generated__/ILazyMint/write/lazyMint.js";
 ...
 * ```
 */
export function createDelayedRevealBatch(options) {
    if (!options.password) {
 ...
 * ```
 */
export function isCreateDelayedRevealBatchSupported(availableSelectors) {
    return [
