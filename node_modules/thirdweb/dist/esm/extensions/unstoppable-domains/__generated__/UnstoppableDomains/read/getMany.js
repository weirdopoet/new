...
export const FN_SELECTOR = "0x1bd8cc1a";
const FN_INPUTS = [
    {
        name: "keys",
        type: "string[]",
 ...
 * ```
 */
export function isGetManySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetManyParams(options) {
 ...
 * ```
 */
export function encodeGetMany(options) {
 ...
 * ```
 */
export function decodeGetManyResult(result) {
