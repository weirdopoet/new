...
export const FN_SELECTOR = "0x1da799c9";
const FN_INPUTS = [
    {
        name: "_bundleId",
        type: "uint256",
 ...
 * ```
 */
export function isGetTokenOfBundleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetTokenOfBundleParams(options) {
 ...
 * ```
 */
export function encodeGetTokenOfBundle(options) {
 ...
 * ```
 */
export function decodeGetTokenOfBundleResult(result) {
 ...
 * ```
 */
export async function getTokenOfBundle(options) {
    return readContract({
