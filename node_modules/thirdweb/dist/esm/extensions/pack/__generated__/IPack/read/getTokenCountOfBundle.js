...
export const FN_SELECTOR = "0xd0d2fe25";
const FN_INPUTS = [
    {
        name: "_bundleId",
        type: "uint256",
 ...
 * ```
 */
export function isGetTokenCountOfBundleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetTokenCountOfBundleParams(options) {
 ...
 * ```
 */
export function encodeGetTokenCountOfBundle(options) {
 ...
 * ```
 */
export function decodeGetTokenCountOfBundleResult(result) {
 ...
 * ```
 */
export async function getTokenCountOfBundle(options) {
    return readContract({
