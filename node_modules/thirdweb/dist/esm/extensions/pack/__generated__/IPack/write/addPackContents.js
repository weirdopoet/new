...
export const FN_SELECTOR = "0xa96b1438";
const FN_INPUTS = [
    {
        name: "_packId",
        type: "uint256",
 ...
 * ```
 */
export function isAddPackContentsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAddPackContentsParams(options) {
 ...
 * ```
 */
export function encodeAddPackContents(options) {
 ...
 * ```
 */
export function addPackContents(options) {
