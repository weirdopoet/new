...
export const FN_SELECTOR = "0xb0381b08";
const FN_INPUTS = [
    {
        name: "_key",
        type: "uint256",
 ...
 * ```
 */
export function isCanUpdatePackSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCanUpdatePackParams(options) {
 ...
 * ```
 */
export function encodeCanUpdatePack(options) {
 ...
 * ```
 */
export function decodeCanUpdatePackResult(result) {
 ...
 * ```
 */
export async function canUpdatePack(options) {
    return readContract({
