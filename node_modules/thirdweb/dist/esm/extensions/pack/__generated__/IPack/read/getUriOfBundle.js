...
export const FN_SELECTOR = "0x61195e94";
const FN_INPUTS = [
    {
        name: "_bundleId",
        type: "uint256",
 ...
 * ```
 */
export function isGetUriOfBundleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetUriOfBundleParams(options) {
 ...
 * ```
 */
export function encodeGetUriOfBundle(options) {
 ...
 * ```
 */
export function decodeGetUriOfBundleResult(result) {
 ...
 * ```
 */
export async function getUriOfBundle(options) {
    return readContract({
