...
export const FN_SELECTOR = "0x8d4c446a";
const FN_INPUTS = [
    {
        name: "_packId",
        type: "uint256",
 ...
 * ```
 */
export function isGetPackContentsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPackContentsParams(options) {
 ...
 * ```
 */
export function encodeGetPackContents(options) {
 ...
 * ```
 */
export function decodeGetPackContentsResult(result) {
 ...
 * ```
 */
export async function getPackContents(options) {
    return readContract({
