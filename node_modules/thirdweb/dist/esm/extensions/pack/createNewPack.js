...
import { createPack, } from "./__generated__/IPack/write/createPack.js";
export var PACK_TOKEN_TYPE;
...
})(PACK_TOKEN_TYPE || (PACK_TOKEN_TYPE = {}));
/**
 ...
 * ```
 */
export function createNewPack(options) {
    return createPack({
...
async function getCreatePackParams(options) {
    const { contract, recipient, packMetadata, amountDistributedPerOpen, openStartTimestamp, erc20Rewards, erc721Rewards, erc1155Rewards, tokenOwner, overrides, } = options;
...
async function processErc20Rewards(options) {
    ...
    const uniqueERC20Contracts = [
        ...new Set(content.map((o) => getContract({
...
async function processErc1155Rewards(options) {
    ...
    const { isApprovedForAll } = await import("../erc1155/__generated__/IERC1155/read/isApprovedForAll.js");
    const numOfRewardUnits = [];
