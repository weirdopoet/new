...
export const FN_SELECTOR = "0x65798bfb";
const FN_INPUTS = [
    {
        type: "address",
        name: "asset",
 ...
 * ```
 */
export function isGetRewardPositionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetRewardPositionParams(options) {
 ...
 * ```
 */
export function encodeGetRewardPosition(options) {
 ...
 * ```
 */
export function decodeGetRewardPositionResult(result) {
 ...
 * ```
 */
export async function getRewardPosition(options) {
    return readContract({
