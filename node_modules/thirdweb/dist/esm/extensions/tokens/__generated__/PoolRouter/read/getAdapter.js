...
export const FN_SELECTOR = "0xd6cbae4d";
const FN_INPUTS = [
    {
        type: "uint8",
        name: "adapterType",
 ...
 * ```
 */
export function isGetAdapterSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetAdapterParams(options) {
 ...
 * ```
 */
export function encodeGetAdapter(options) {
 ...
 * ```
 */
export function decodeGetAdapterResult(result) {
