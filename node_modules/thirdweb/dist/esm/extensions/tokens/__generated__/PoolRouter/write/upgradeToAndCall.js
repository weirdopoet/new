...
export const FN_SELECTOR = "0x4f1ef286";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isUpgradeToAndCallSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUpgradeToAndCallParams(options) {
 ...
 * ```
 */
export function encodeUpgradeToAndCall(options) {
 ...
 * ```
 */
export function upgradeToAndCall(options) {
