...
export const FN_SELECTOR = "0x2cb1f780";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "request",
 ...
 * ```
 */
export function isEnableAdapterWithSignatureSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeEnableAdapterWithSignatureParams(options) {
 ...
 * ```
 */
export function encodeEnableAdapterWithSignature(options) {
 ...
 * ```
 */
export function enableAdapterWithSignature(options) {
