...
export const FN_SELECTOR = "0xa3f3a7bd";
const FN_INPUTS = [
    {
        type: "uint8",
        name: "adapterType",
 ...
 * ```
 */
export function isDisableAdapterSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDisableAdapterParams(options) {
 ...
 * ```
 */
export function encodeDisableAdapter(options) {
 ...
 * ```
 */
export function disableAdapter(options) {
