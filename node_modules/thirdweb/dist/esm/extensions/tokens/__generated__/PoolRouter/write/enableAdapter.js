...
export const FN_SELECTOR = "0xa5a2fa73";
const FN_INPUTS = [
    {
        type: "uint8",
        name: "adapterType",
 ...
 * ```
 */
export function isEnableAdapterSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeEnableAdapterParams(options) {
 ...
 * ```
 */
export function encodeEnableAdapter(options) {
 ...
 * ```
 */
export function enableAdapter(options) {
