 ...
 * @example
 * ```ts
 * import { isOwnershipHandoverExpiresAtSupported } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodeOwnershipHandoverExpiresAtParams } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodeOwnershipHandoverExpiresAt } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { decodeOwnershipHandoverExpiresAtResult } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { ownershipHandoverExpiresAt } from "thirdweb/extensions/tokens";
 *
