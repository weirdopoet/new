...
export const FN_SELECTOR = "0xe4d59447";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "request",
 ...
 * ```
 */
export function isDeployContractWithSignatureSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDeployContractWithSignatureParams(options) {
 ...
 * ```
 */
export function encodeDeployContractWithSignature(options) {
 ...
 * ```
 */
export function deployContractWithSignature(options) {
