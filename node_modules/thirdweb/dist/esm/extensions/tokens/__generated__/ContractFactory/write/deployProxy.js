...
export const FN_SELECTOR = "0xfe513ef9";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "id",
 ...
 * ```
 */
export function isDeployProxySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDeployProxyParams(options) {
 ...
 * ```
 */
export function encodeDeployProxy(options) {
 ...
 * ```
 */
export function deployProxy(options) {
