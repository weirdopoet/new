...
export const FN_SELECTOR = "0x7bd1368b";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "request",
 ...
 * ```
 */
export function isDeployProxyWithSignatureSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDeployProxyWithSignatureParams(options) {
 ...
 * ```
 */
export function encodeDeployProxyWithSignature(options) {
 ...
 * ```
 */
export function deployProxyWithSignature(options) {
