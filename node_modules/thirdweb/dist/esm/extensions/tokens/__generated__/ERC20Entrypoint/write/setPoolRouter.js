...
export const FN_SELECTOR = "0x0c8d9cc7";
const FN_INPUTS = [
    {
        type: "address",
        name: "poolRouter",
 ...
 * ```
 */
export function isSetPoolRouterSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetPoolRouterParams(options) {
    return encodeAbiParameters(FN_INPUTS, [options.poolRouter]);
}
/**
 ...
 * ```
 */
export function encodeSetPoolRouter(options) {
 ...
 * ```
 */
export function setPoolRouter(options) {
