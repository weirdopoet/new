...
export const FN_SELECTOR = "0x1a1b2b88";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "config",
 ...
 * ```
 */
export function isCreateByImplementationConfigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCreateByImplementationConfigParams(options) {
 ...
 * ```
 */
export function encodeCreateByImplementationConfig(options) {
 ...
 * ```
 */
export function createByImplementationConfig(options) {
