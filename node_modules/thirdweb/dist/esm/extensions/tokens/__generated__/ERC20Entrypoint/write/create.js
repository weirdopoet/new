...
export const FN_SELECTOR = "0x65d53dd9";
const FN_INPUTS = [
    {
        type: "address",
        name: "creator",
 ...
 * ```
 */
export function isCreateSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCreateParams(options) {
 ...
 * ```
 */
export function encodeCreate(options) {
