...
export const FN_SELECTOR = "0x824f512c";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isGetPoolRouterSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetPoolRouterResult(result) {
 ...
 * ```
 */
export async function getPoolRouter(options) {
    return readContract({
