...
export const FN_SELECTOR = "0x1889d488";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "contractId",
 ...
 * ```
 */
export function isCreateByIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCreateByIdParams(options) {
 ...
 * ```
 */
export function encodeCreateById(options) {
 ...
 * ```
 */
export function createById(options) {
