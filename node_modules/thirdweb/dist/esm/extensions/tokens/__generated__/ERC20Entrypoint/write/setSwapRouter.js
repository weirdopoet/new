...
export const FN_SELECTOR = "0x41273657";
const FN_INPUTS = [
    {
        type: "address",
        name: "swapRouter",
 ...
 * ```
 */
export function isSetSwapRouterSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetSwapRouterParams(options) {
 ...
 * ```
 */
export function encodeSetSwapRouter(options) {
 ...
 * ```
 */
export function setSwapRouter(options) {
