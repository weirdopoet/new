...
export const FN_SELECTOR = "0x4bf8055d";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "config",
 ...
 * ```
 */
export function isAddImplementationSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAddImplementationParams(options) {
 ...
 * ```
 */
export function encodeAddImplementation(options) {
 ...
 * ```
 */
export function addImplementation(options) {
