...
export const FN_SELECTOR = "0xd25f82a0";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isGetAirdropSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetAirdropResult(result) {
 ...
 * ```
 */
export async function getAirdrop(options) {
    return readContract({
