...
export const FN_SELECTOR = "0x72820dbc";
const FN_INPUTS = [
    {
        type: "address",
        name: "airdrop",
 ...
 * ```
 */
export function isSetAirdropSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetAirdropParams(options) {
 ...
 * ```
 */
export function encodeSetAirdrop(options) {
 ...
 * ```
 */
export function setAirdrop(options) {
