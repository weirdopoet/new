...
export const FN_SELECTOR = "0xd0fb0203";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isFeeManagerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeFeeManagerResult(result) {
 ...
 * ```
 */
export async function feeManager(options) {
    return readContract({
