...
export const FN_SELECTOR = "0x791b98bc";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isPositionManagerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodePositionManagerResult(result) {
 ...
 * ```
 */
export async function positionManager(options) {
    return readContract({
