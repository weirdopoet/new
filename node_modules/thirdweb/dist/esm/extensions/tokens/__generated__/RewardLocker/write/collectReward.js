...
export const FN_SELECTOR = "0x7bb87377";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
 ...
 * ```
 */
export function isCollectRewardSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCollectRewardParams(options) {
 ...
 * ```
 */
export function encodeCollectReward(options) {
 ...
 * ```
 */
export function collectReward(options) {
