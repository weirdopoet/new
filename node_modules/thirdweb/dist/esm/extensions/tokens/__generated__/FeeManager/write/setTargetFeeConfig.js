...
export const FN_SELECTOR = "0xd20caa1a";
const FN_INPUTS = [
    {
        type: "address",
        name: "target",
 ...
 * ```
 */
export function isSetTargetFeeConfigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetTargetFeeConfigParams(options) {
 ...
 * ```
 */
export function encodeSetTargetFeeConfig(options) {
 ...
 * ```
 */
export function setTargetFeeConfig(options) {
