...
export const FN_SELECTOR = "0xe74b981b";
const FN_INPUTS = [
    {
        type: "address",
        name: "_feeRecipient",
 ...
 * ```
 */
export function isSetFeeRecipientSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetFeeRecipientParams(options) {
 ...
 * ```
 */
export function encodeSetFeeRecipient(options) {
