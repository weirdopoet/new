...
export const FN_SELECTOR = "0xfeb61724";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "signerNonce",
 ...
 * ```
 */
export function isUsedNoncesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUsedNoncesParams(options) {
 ...
 * ```
 */
export function encodeUsedNonces(options) {
 ...
 * ```
 */
export function decodeUsedNoncesResult(result) {
 ...
 * ```
 */
export async function usedNonces(options) {
    return readContract({
