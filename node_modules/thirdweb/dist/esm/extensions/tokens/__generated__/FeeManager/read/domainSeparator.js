...
export const FN_SELECTOR = "0xf698da25";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
export function isDomainSeparatorSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeDomainSeparatorResult(result) {
 ...
 * ```
 */
export async function domainSeparator(options) {
    return readContract({
