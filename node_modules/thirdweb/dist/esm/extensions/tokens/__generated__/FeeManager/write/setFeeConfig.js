...
export const FN_SELECTOR = "0x636d2be9";
const FN_INPUTS = [
    {
        type: "bytes4",
        name: "action",
 ...
 * ```
 */
export function isSetFeeConfigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetFeeConfigParams(options) {
 ...
 * ```
 */
export function encodeSetFeeConfig(options) {
