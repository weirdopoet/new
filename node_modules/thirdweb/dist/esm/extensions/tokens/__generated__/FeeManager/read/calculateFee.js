...
export const FN_SELECTOR = "0x69588801";
const FN_INPUTS = [
    {
        type: "address",
        name: "payer",
 ...
 * ```
 */
export function isCalculateFeeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCalculateFeeParams(options) {
 ...
 * ```
 */
export function encodeCalculateFee(options) {
 ...
 * ```
 */
export function decodeCalculateFeeResult(result) {
