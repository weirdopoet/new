...
export const FN_SELECTOR = "0x99ba5936";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isROLE_FEE_MANAGERSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeROLE_FEE_MANAGERResult(result) {
 ...
 * ```
 */
export async function ROLE_FEE_MANAGER(options) {
    return readContract({
