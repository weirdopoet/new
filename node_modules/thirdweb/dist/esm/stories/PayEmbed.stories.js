...
export function BasicUsage() {
    return _jsx(PayEmbed, { client: storyClient });
}
export function BasicUsageWithMetadata() {
    return (_jsx(PayEmbed, { client: storyClient, payOptions: {
            metadata: {
...
export function LightMode() {
    return _jsx(PayEmbed, { client: storyClient, theme: "light" });
}
export function CustomLightTheme() {
    return (_jsx(PayEmbed, { client: storyClient, theme: lightTheme({
            colors: {
                modalBg: "#FFFFF0",
                tertiaryBg: "#DBE4C9",
                borderColor: "#8AA624",
