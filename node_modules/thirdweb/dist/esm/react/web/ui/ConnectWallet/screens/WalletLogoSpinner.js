...
export function WalletLogoSpinner(props) {
    ...
    return (_jsx(LogoContainer, { "data-error": props.error, children: _jsx("div", { "data-container": true, style: {
                alignItems: "center",
                display: "flex",
                justifyContent: "center",
                position: "relative",
            }, children: _jsxs("div", { "data-img-container": true, children: [!props.hideSpinner && (_jsx("svg", { role: "presentation", style: {
                            display: props.error ? "none" : "block",
                        }, viewBox: "0 0 110 110", children: _jsx("rect", { fill: "none", height: "106", rx: loaderRadius, strokeDasharray: `${dashArrayStart} ${dashArrayEnd}`, strokeDashoffset: dashOffset, strokeLinecap: "round", strokeWidth: 4, width: "106", x: "2", y: "2" }) })), _jsx(WalletBg, { children: _jsx(WalletImage, { client: props.client, id: props.id, size: "68" }) })] }) }) }));
}
