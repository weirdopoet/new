 ...
 * @beta
 */
export function TokenSymbol({ symbolResolver, formatFn, loadingComponent, fallbackComponent, queryOptions, ...restProps }) {
    ...
    if (formatFn && typeof formatFn === "function") {
        return _jsx("span", { ...restProps, children: formatFn(symbolQuery.data) });
    }
    return _jsx("span", { ...restProps, children: symbolQuery.data });
}
/**
