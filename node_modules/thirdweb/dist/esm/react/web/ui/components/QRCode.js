...
const QRCodeRenderer = /* @__PURE__ */ lazy(() => import("./QRCode/QRCodeRenderer.js"));
/**
 * @internal
 */
export const QRCode = (props) => {
    const size = props.size || 310;
    const placeholder = (_jsxs(QRPlaceholder, { style: {
            height: `${size}px`,
            width: `${size}px`,
        }, children: [_jsx("span", { "data-v1": true }), _jsx("span", { "data-v2": true }), _jsx("span", { "data-v3": true }), _jsx("div", {})] }));
    return (_jsxs("div", { style: {
            display: "flex",
            justifyContent: "center",
            position: "relative",
        }, children: [props.qrCodeUri ? (_jsx(Suspense, { fallback: placeholder, children: _jsx(QRCodeContainer, { children: _jsx(QRCodeRenderer, { clearSize: props.QRIcon ? 70 : undefined, ecl: "M", size: size + 20, uri: props.qrCodeUri }) }) })) : (placeholder), props.QRIcon && _jsx(IconContainer, { children: props.QRIcon })] }));
};
