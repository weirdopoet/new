...
export function TransactionButton(props) {
    ...
    return (_jsx(CustomThemeProvider, { theme: props.theme, children: _jsxs(Button, { "data-is-loading": isPending, disabled: !account || disabled || isPending, gap: "xs", onClick: () => handleClick(), unstyled: unstyled, variant: "primary", ...buttonProps, style: !unstyled
                ? {
                    minWidth: "165px",
                ...
                : {
                    ...
                    ...buttonProps.style,
                        ...
                        position: "absolute",
                        top: 0,
                    }, children: _jsx(Spinner, { color: "primaryButtonText", size: "md" }) }))] }) }));
}
