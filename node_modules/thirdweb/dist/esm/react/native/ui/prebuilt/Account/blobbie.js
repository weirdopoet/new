...
export function Blobbie(props) {
    ...
    return (_jsx(View, { style: [styles.container, containerStyle], children: _jsxs(Svg, { height: "100%", style: StyleSheet.absoluteFillObject, width: "100%", children: [_jsx(Defs, { children: _jsxs(LinearGradient, { id: gradientUniqueId, x1: "0%", x2: "100%", y1: "100%", y2: "0%", children: [_jsx(Stop, { offset: "0", stopColor: colors[0] }), _jsx(Stop, { offset: "1", stopColor: colors[1] })] }) }), _jsx(Rect, { fill: `url(#${gradientUniqueId})`, height: "100%", width: "100%" })] }) }));
}
