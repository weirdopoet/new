...
exports.SaltFlag = void 0;
exports.encodeInitParams = encodeInitParams;
exports.encodePoolConfig = encodePoolConfig;
exports.generateSalt = generateSalt;
const viem_1 = require("viem");
const utils_1 = require("viem/utils");
const addresses_js_1 = require("../constants/addresses.js");
const initialize_js_1 = require("../extensions/tokens/__generated__/ERC20Asset/write/initialize.js");
...
async function encodeInitParams(options) {
    ...
    const contractURI = options.params.contractURI ||
        ...
        "";
    return (0, initialize_js_1.encodeInitialize)({
        contractURI,
        owner: creator,
        name: params.name,
        symbol: params.symbol || params.name,
        maxSupply: (0, units_js_1.toUnits)(params.maxSupply.toString() || constants_js_1.DEFAULT_MAX_SUPPLY_ERC20.toString(), 18),
    });
}
function encodePoolConfig(poolConfig) {
    const POOL_PARAMS = [
        {
            name: "amount",
            type: "uint256",
    ...
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(POOL_PARAMS, [
        (0, units_js_1.toUnits)(poolConfig.amount.toString(), 18),
        poolConfig.currency || addresses_js_1.NATIVE_TOKEN_ADDRESS,
        poolConfig.initialTick || constants_js_1.DEFAULT_POOL_INITIAL_TICK,
        poolConfig.developerRewardBps || constants_js_1.DEFAULT_DEVELOPER_REWARD_BPS,
    ]);
}
function generateSalt(salt, flags = exports.SaltFlag.MIX_SENDER) {
    /*
    ...
    if (saltData.length !== 62) {
        ...
        throw new Error("salt data (excluding flag byte) cannot exceed 31 bytes (62 hex characters)");
    }
    const result = `0x${flagByte.toString(16).padStart(2, "0")}${saltData}`;
