...
exports.uploadBatchMobile = uploadBatchMobile;
...
async function uploadBatchMobile(client, data, options) {
    ...
    if (typeof data[0] === "object" &&
        ...
        return new Promise((resolve, reject) => {
            ...
            for (const [key, value] of (0, fetch_js_1.getPlatformHeaders)()) {
    ...
    try {
        const res = await (0, fetch_js_1.getClientFetch)(client)(`https://${(0, domains_js_1.getThirdwebDomains)().storage}/ipfs/batch-pin-json`, {
            body: fetchBody,
            headers: {
