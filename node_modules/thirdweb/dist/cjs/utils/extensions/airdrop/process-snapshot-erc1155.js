...
exports.processSnapshotERC1155 = processSnapshotERC1155;
...
async function processSnapshotERC1155(options) {
    ...
    const originalEntriesUri = await (0, upload_js_1.upload)({
        client: options.client,
        files: [(0, json_js_1.stringify)(options.snapshot)],
    });
...
//# sourceMappingURL=process-snapshot-erc1155.js.map