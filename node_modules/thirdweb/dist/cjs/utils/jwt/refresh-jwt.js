...
const decode_jwt_js_1 = require("./decode-jwt.js");
const encode_jwt_js_1 = require("./encode-jwt.js");
...
async function refreshJWT(options) {
    ...
    const payload = (0, decode_jwt_js_1.decodeJWT)(jwt).payload;
    return (0, encode_jwt_js_1.encodeJWT)({
        account,
        payload: {
            aud: payload.aud,
            ctx: payload.ctx,
