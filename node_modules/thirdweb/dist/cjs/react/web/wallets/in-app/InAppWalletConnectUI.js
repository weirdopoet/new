...
function InAppWalletConnectUI(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(InAppWalletFormUI_js_1.InAppWalletFormUIScreen, { chain: props.chain, client: props.client, connectLocale: props.connectLocale, done: done, goBack: props.goBack, inAppWalletLocale: locale, isLinking: props.isLinking, meta: props.meta, select: () => { }, size: props.size, wallet: props.wallet }));
}
