...
function WalletManagerScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { onBack: props.onBack, title: "Wallets" }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "md", style: {
                    minHeight: "150px",
                        ...
                        .map((w) => {
                        return ((0, jsx_runtime_1.jsx)(WalletManangerButton, { chain: props.activeChain, client: props.client, onClick: () => {
                                setActive(w);
                                props.onBack();
                            }, wallet: w }, w.id));
                    }) }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xxl" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: !hideConnectButton && ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { fullWidth: true, gap: "xs", onClick: () => {
                        setScreen("connect");
                    }, variant: "accent", children: [(0, jsx_runtime_1.jsx)(react_icons_1.PlusIcon, { height: index_js_1.iconSize.sm, width: index_js_1.iconSize.sm }), "Connect Wallet"] })) })] }));
}
function WalletManangerButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
            position: "relative",
                ...
                }, children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "y", flex: "row", gap: "md", children: [(0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { client: props.client, id: walletId, size: index_js_1.iconSize.lg }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "4xs", children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: (0, address_js_1.shortenAddress)(address || "") }), balanceQuery.data ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", size: "xs", weight: 400, children: (0, formatTokenBalance_js_1.formatTokenBalance)(balanceQuery.data) })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_1.fontSize.sm, width: "100px" }))] })] }) }), (0, jsx_runtime_1.jsx)("div", { style: {
                    position: "absolute",
                    right: index_js_1.spacing.xxs,
                    top: "50%",
                    transform: "translateY(-50%)",
                    zIndex: 1,
                }, children: activeWallet?.id === props.wallet.id ? ((0, jsx_runtime_1.jsx)(Tooltip_js_1.ToolTip, { tip: "Active Wallet", children: (0, jsx_runtime_1.jsx)(buttons_js_1.IconButton, { children: (0, jsx_runtime_1.jsx)(react_icons_1.CheckIcon, { height: index_js_1.iconSize.md, width: index_js_1.iconSize.md }) }) })) : ((0, jsx_runtime_1.jsx)(Tooltip_js_1.ToolTip, { tip: "Disconnect", children: (0, jsx_runtime_1.jsx)(buttons_js_1.IconButton, { onClick: () => {
                            disconnect(props.wallet);
                        }, children: (0, jsx_runtime_1.jsx)(react_icons_1.MinusIcon, { height: index_js_1.iconSize.md, style: {
