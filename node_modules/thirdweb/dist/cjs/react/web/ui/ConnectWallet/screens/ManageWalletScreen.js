...
function ManageWalletScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
            minHeight: "300px",
        }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { onBack: props.onBack, title: props.locale.manageWallet.title }) }), (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "sm", scrollY: true, style: {
                    maxHeight: "500px",
                }, children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: { height: "250px", position: "relative" }, children: [(0, jsx_runtime_1.jsx)(SwitchMetamaskAccount, { closeModal: props.closeModal, connectLocale: props.locale }), typeof wallet !== "undefined" &&
                                props.manageWallet?.allowLinkingProfiles !== false && ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
                                    ...
                                    fontSize: index_js_2.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(WalletConnectIcon_js_1.WalletConnectIcon, { size: index_js_2.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: props.locale.manageWallet.connectAnApp })] }), wallet &&
                                (0, index_js_1.isInAppWallet)(wallet) &&
                                !wallet.getConfig()?.hidePrivateKeyExport && ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
...
function SwitchMetamaskAccount(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: async () => {
            await injectedMetamaskProvider.request({
                method: "wallet_requestPermissions",
                params: [{ eth_accounts: {} }],
            });
            props.closeModal();
        }, type: "button", children: [(0, jsx_runtime_1.jsx)(react_icons_1.ShuffleIcon, { height: index_js_2.iconSize.md, width: index_js_2.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: connectLocale.switchAccount })] }));
}
