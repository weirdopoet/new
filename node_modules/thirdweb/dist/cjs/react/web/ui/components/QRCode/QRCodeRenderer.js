...
function QRCodeRenderer({ ecl = "M", size: sizeProp = 200, uri, clearSize = 0, image, imageBackground = "transparent", }) {
    ...
    const dots = (0, react_1.useMemo)(() => {
        const dotsArray = [];
        const matrix = (0, uqr_1.encode)(uri, { border: 0, ecc: ecl }).data;
    ...
    return ((0, jsx_runtime_1.jsxs)("svg", { height: size, role: "presentation", style: {
            height: size,
            width: size,
        }, viewBox: `0 0 ${size} ${size}`, width: size, children: [(0, jsx_runtime_1.jsx)("rect", { fill: "transparent", height: size, width: size }), dots] }));
}
