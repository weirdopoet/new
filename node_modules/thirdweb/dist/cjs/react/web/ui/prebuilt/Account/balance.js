...
function AccountBalance({ chain, tokenAddress, loadingComponent, fallbackComponent, queryOptions, formatFn, showBalanceInFiat, ...restProps }) {
    ...
    if (showBalanceInFiat) {
        return ((0, jsx_runtime_1.jsx)("span", { ...restProps, children: (0, account_js_1.formatAccountFiatBalance)({ ...balanceQuery.data, decimals: 0 }) }));
    }
    return ((0, jsx_runtime_1.jsx)("span", { ...restProps, children: (0, account_js_1.formatAccountTokenBalance)({
            ...balanceQuery.data,
