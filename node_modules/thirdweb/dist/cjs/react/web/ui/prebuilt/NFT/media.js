...
function NFTMedia({ loadingComponent, fallbackComponent, queryOptions, mediaResolver, ...mediaRendererProps }) {
    ...
    return ((0, jsx_runtime_1.jsx)(MediaRenderer_js_1.MediaRenderer, { client: contract.client, poster: mediaQuery.data.poster, src: mediaQuery.data.src, ...mediaRendererProps }));
}
/**
 * @internal
 */
