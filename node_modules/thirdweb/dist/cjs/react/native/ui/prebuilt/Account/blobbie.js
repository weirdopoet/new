...
function Blobbie(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: [styles.container, containerStyle], children: (0, jsx_runtime_1.jsxs)(react_native_svg_1.Svg, { height: "100%", style: react_native_1.StyleSheet.absoluteFillObject, width: "100%", children: [(0, jsx_runtime_1.jsx)(react_native_svg_1.Defs, { children: (0, jsx_runtime_1.jsxs)(react_native_svg_1.LinearGradient, { id: gradientUniqueId, x1: "0%", x2: "100%", y1: "100%", y2: "0%", children: [(0, jsx_runtime_1.jsx)(react_native_svg_1.Stop, { offset: "0", stopColor: colors[0] }), (0, jsx_runtime_1.jsx)(react_native_svg_1.Stop, { offset: "1", stopColor: colors[1] })] }) }), (0, jsx_runtime_1.jsx)(react_native_svg_1.Rect, { fill: `url(#${gradientUniqueId})`, height: "100%", width: "100%" })] }) }));
}
