...
const ChainIcon = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(RNImage_js_1.RNImage, { color: props.theme.colors.secondaryIconColor, data: data, placeholder: svgs_js_1.CHAIN_ICON, size: props.size, theme: props.theme }));
};
