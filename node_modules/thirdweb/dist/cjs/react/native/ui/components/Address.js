...
const Address = ({ account, theme, addressOrENS }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.TouchableOpacity, { onPress: () => {
        ...
        }, style: styles.addressContainer, children: [(0, jsx_runtime_1.jsx)(text_js_1.ThemedText, { theme: theme, type: "defaultSemiBold", children: addressOrENS }), (0, jsx_runtime_1.jsx)(RNImage_js_1.RNImage, { color: copySuccess ? theme.colors.success : theme.colors.secondaryIconColor, data: copySuccess ? svgs_js_1.CHECK : svgs_js_1.COPY_ICON, size: 15, theme: theme })] }));
};
