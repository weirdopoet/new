...
const LoadingView = (props) => {
    const { theme } = props;
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: styles.container, children: (0, jsx_runtime_1.jsx)(spinner_js_1.ThemedSpinner, { color: theme.colors.accentText, size: "large" }) }));
};
