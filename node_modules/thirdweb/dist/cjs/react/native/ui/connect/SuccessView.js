...
const SuccessView = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: styles.container, children: [(0, jsx_runtime_1.jsx)(RNImage_js_1.RNImage, { color: theme.colors.success, data: svgs_js_1.CHECK_CIRCLE, size: 64, theme: theme }), (0, jsx_runtime_1.jsx)(text_js_1.ThemedText, { style: { color: theme.colors.success, textAlign: "center" }, theme: theme, type: "defaultSemiBold", children: title })] }));
};
