...
const TokenListScreen = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.ScrollView, { style: { flex: 1 }, children: (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: styles.listContainer, children: [(0, jsx_runtime_1.jsx)(exports.TokenRow, { address: account?.address, chain: chain, client: props.client, onTokenSelected: props.onTokenSelected, theme: props.theme }), tokens.map((t) => {
                    return ((0, jsx_runtime_1.jsx)(exports.TokenRow, { address: account?.address, chain: chain, client: props.client, onTokenSelected: props.onTokenSelected, theme: props.theme, token: t }, t.address));
                })] }) }));
};
...
const TokenRow = (props) => {
    ...
    const inner = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(TokenIcon_js_1.TokenIcon, { chain: chain, client: client, size: 40, theme: theme, token: token }), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { flexDirection: "column", gap: index_js_1.spacing.xxs }, children: [(0, jsx_runtime_1.jsx)(text_js_1.ThemedText, { theme: theme, type: "defaultSemiBold", children: tokenName }), address &&
                        (balanceQuery.data ? ((0, jsx_runtime_1.jsxs)(text_js_1.ThemedText, { theme: theme, type: "subtext", children: [formatBalanceOnButton(Number(balanceQuery.data.displayValue)), " ", balanceQuery.data?.symbol] })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { style: { height: 14, width: 80 }, theme: theme })))] }), props.onTokenSelected && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_native_1.View, { style: { flex: 1 } }), (0, jsx_runtime_1.jsx)(RNImage_js_1.RNImage, { color: theme.colors.secondaryIconColor, data: svgs_js_1.RIGHT_CHEVRON, size: 24, theme: theme })] }))] }));
    return onTokenSelected ? ((0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, { onPress: () => onTokenSelected(token), style: styles.tokenRowContainer, children: inner })) : ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: styles.tokenRowContainer, children: inner }));
};
