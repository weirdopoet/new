                        ...
                        if ((0, type_guards_js_1.isObjectWithKeys)(data, ["transactionHash"]) &&
                            ...
                            (0, wait_for_tx_receipt_js_1.waitForReceipt)({
                                ...
                                return Promise.all([
                                    ...
                                    (0, invalidateWalletBalance_js_1.invalidateWalletBalance)(queryClient, variables.__contract?.chain.id || variables.chain.id),
                                ]);
                            });
                        }
                    }
