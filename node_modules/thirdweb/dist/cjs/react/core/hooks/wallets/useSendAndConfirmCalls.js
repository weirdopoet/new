...
exports.useSendAndConfirmCalls = useSendAndConfirmCalls;
const react_query_1 = require("@tanstack/react-query");
const send_and_confirm_calls_js_1 = require("../../../../wallets/eip5792/send-and-confirm-calls.js");
...
function useSendAndConfirmCalls(args) {
    ...
    return (0, react_query_1.useMutation)({
        mutationFn: async (options) => {
            ...
            return (0, send_and_confirm_calls_js_1.sendAndConfirmCalls)({
                ...options,
...
//# sourceMappingURL=useSendAndConfirmCalls.js.map