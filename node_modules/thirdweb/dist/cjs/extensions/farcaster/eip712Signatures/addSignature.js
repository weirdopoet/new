...
exports.getAddData = getAddData;
exports.signAdd = signAdd;
const constants_js_1 = require("../constants.js");
const KEY_GATEWAY_EIP_712_DOMAIN = {
    chainId: 10,
    name: "Farcaster KeyGateway",
    verifyingContract: constants_js_1.KEY_GATEWAY_ADDRESS,
    version: "1",
};
 ...
 * ```
 */
async function signAdd(options) {
