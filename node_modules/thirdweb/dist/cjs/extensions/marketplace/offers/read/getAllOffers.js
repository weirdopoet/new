...
const getAllOffers_js_1 = require("../../__generated__/IOffers/read/getAllOffers.js");
...
async function getAllOffers(options) {
    ...
    const [rawOffers, latestBlock] = await Promise.all([
        (0, utils_js_1.getAllInBatches)((startId, endId) => (0, getAllOffers_js_1.getAllOffers)({ contract: options.contract, endId, startId }), {
            end,
