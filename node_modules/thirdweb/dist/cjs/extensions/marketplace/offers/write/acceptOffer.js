...
const allowance_js_1 = require("../../../erc20/__generated__/IERC20/read/allowance.js");
const balanceOf_js_1 = require("../../../erc20/__generated__/IERC20/read/balanceOf.js");
const acceptOffer_js_1 = require("../../__generated__/IOffers/write/acceptOffer.js");
const getOffer_js_1 = require("../read/getOffer.js");
/**
...
function acceptOffer(options) {
    return (0, acceptOffer_js_1.acceptOffer)({
        asyncParams: async () => {
            const offer = await (0, getOffer_js_1.getOffer)({
            ...
            const [offerorBalance, offerorAllowance] = await Promise.all([
                (0, balanceOf_js_1.balanceOf)({
                    address: offer.offerorAddress,
                    contract: currencyContract,
                }),
                (0, allowance_js_1.allowance)({
                    contract: currencyContract,
