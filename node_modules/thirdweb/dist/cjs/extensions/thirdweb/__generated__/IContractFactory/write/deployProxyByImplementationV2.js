...
exports.isDeployProxyByImplementationV2Supported = isDeployProxyByImplementationV2Supported;
exports.encodeDeployProxyByImplementationV2Params = encodeDeployProxyByImplementationV2Params;
exports.encodeDeployProxyByImplementationV2 = encodeDeployProxyByImplementationV2;
exports.deployProxyByImplementationV2 = deployProxyByImplementationV2;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0xd057c8b1";
const FN_INPUTS = [
    {
        name: "implementation",
        type: "address",
 ...
 * ```
 */
function isDeployProxyByImplementationV2Supported(availableSelectors) {
 ...
 * ```
 */
function encodeDeployProxyByImplementationV2Params(options) {
 ...
 * ```
 */
function encodeDeployProxyByImplementationV2(options) {
 ...
 * ```
 */
function deployProxyByImplementationV2(options) {
