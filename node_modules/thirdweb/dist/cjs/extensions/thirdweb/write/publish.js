...
const getAllExtensions_js_1 = require("../../../extensions/dynamic-contracts/__generated__/IExtensionManager/read/getAllExtensions.js");
    ...
    return (0, publishContract_js_1.publishContract)({
        async asyncParams() {
            ...
            const newMetadata = {
                ...
                defaultExtensions: routerType === "dynamic"
                    ? options.metadata.defaultExtensions
                    : undefined,
                defaultModules: routerType === "modular"
...
function getRouterType(abi) {
    ...
    const isDynamic = (0, getAllExtensions_js_1.isGetAllExtensionsSupported)(fnSelectors);
