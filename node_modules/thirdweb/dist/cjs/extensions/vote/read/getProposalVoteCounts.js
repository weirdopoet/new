...
exports.getProposalVoteCounts = getProposalVoteCounts;
const proposalVotes_js_1 = require("../__generated__/Vote/read/proposalVotes.js");
/**
 ...
 * ```
 */
async function getProposalVoteCounts(options) {
    const votes = await (0, proposalVotes_js_1.proposalVotes)(options);
    return {
        abstain: votes[2],
        against: votes[0],
        for: votes[1],
...
//# sourceMappingURL=getProposalVoteCounts.js.map