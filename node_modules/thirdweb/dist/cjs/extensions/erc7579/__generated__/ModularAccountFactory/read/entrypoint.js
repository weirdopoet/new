...
exports.isEntrypointSupported = isEntrypointSupported;
exports.decodeEntrypointResult = decodeEntrypointResult;
exports.entrypoint = entrypoint;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xa65d69d4";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isEntrypointSupported(availableSelectors) {
 ...
 * ```
 */
function decodeEntrypointResult(result) {
