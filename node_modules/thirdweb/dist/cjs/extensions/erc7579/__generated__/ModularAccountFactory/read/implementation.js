...
exports.isImplementationSupported = isImplementationSupported;
exports.decodeImplementationResult = decodeImplementationResult;
exports.implementation = implementation;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x5c60da1b";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "result",
 ...
 * ```
 */
function isImplementationSupported(availableSelectors) {
 ...
 * ```
 */
function decodeImplementationResult(result) {
 ...
 * ```
 */
async function implementation(options) {
