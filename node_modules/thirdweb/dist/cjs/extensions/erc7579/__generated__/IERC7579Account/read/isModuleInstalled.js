...
exports.isIsModuleInstalledSupported = isIsModuleInstalledSupported;
exports.encodeIsModuleInstalledParams = encodeIsModuleInstalledParams;
exports.encodeIsModuleInstalled = encodeIsModuleInstalled;
exports.decodeIsModuleInstalledResult = decodeIsModuleInstalledResult;
exports.isModuleInstalled = isModuleInstalled;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x112d3a7d";
const FN_INPUTS = [
    {
        name: "moduleTypeId",
        type: "uint256",
 ...
 * ```
 */
function isIsModuleInstalledSupported(availableSelectors) {
 ...
 * ```
 */
function encodeIsModuleInstalledParams(options) {
 ...
 * ```
 */
function encodeIsModuleInstalled(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeIsModuleInstalledParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeIsModuleInstalledResult(result) {
 ...
 * ```
 */
async function isModuleInstalled(options) {
