...
exports.isAccountIdSupported = isAccountIdSupported;
exports.decodeAccountIdResult = decodeAccountIdResult;
exports.accountId = accountId;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x9cfd7cff";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
function isAccountIdSupported(availableSelectors) {
 ...
 * ```
 */
function decodeAccountIdResult(result) {
 ...
 * ```
 */
async function accountId(options) {
