...
exports.isCreateDelayedRevealBatchSupported = isCreateDelayedRevealBatchSupported;
    ...
    return (0, lazyMint_js_1.lazyMint)({
        asyncParams: async () => {
            const [placeholderUris, startFileNumber] = await Promise.all([
                ...
                (0, nextTokenIdToMint_js_1.nextTokenIdToMint)({
...
function isCreateDelayedRevealBatchSupported(availableSelectors) {
    return [
        (0, getBaseURICount_js_1.isGetBaseURICountSupported)(availableSelectors),
        (0, encryptDecrypt_js_1.isEncryptDecryptSupported)(availableSelectors),
        (0, lazyMint_js_1.isLazyMintSupported)(availableSelectors),
    ].every(Boolean);
}
