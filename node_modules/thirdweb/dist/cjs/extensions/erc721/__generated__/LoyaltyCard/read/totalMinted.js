...
exports.isTotalMintedSupported = isTotalMintedSupported;
exports.decodeTotalMintedResult = decodeTotalMintedResult;
exports.totalMinted = totalMinted;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xa2309ff8";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isTotalMintedSupported(availableSelectors) {
 ...
 * ```
 */
function decodeTotalMintedResult(result) {
 ...
 * ```
 */
async function totalMinted(options) {
...
//# sourceMappingURL=totalMinted.js.map