...
exports.isWrapSupported = isWrapSupported;
exports.encodeWrapParams = encodeWrapParams;
...
exports.FN_SELECTOR = "0x29e471dd";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
function isWrapSupported(availableSelectors) {
 ...
 * ```
 */
function encodeWrapParams(options) {
 ...
 * ```
 */
function encodeWrap(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeWrapParams(options).slice(2));
}
/**
