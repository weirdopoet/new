...
exports.isEnableAdapterWithSignatureSupported = isEnableAdapterWithSignatureSupported;
exports.encodeEnableAdapterWithSignatureParams = encodeEnableAdapterWithSignatureParams;
exports.encodeEnableAdapterWithSignature = encodeEnableAdapterWithSignature;
exports.enableAdapterWithSignature = enableAdapterWithSignature;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x2cb1f780";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "request",
 ...
 * ```
 */
function isEnableAdapterWithSignatureSupported(availableSelectors) {
 ...
 * ```
 */
function encodeEnableAdapterWithSignatureParams(options) {
 ...
 * ```
 */
function encodeEnableAdapterWithSignature(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeEnableAdapterWithSignatureParams(options).slice(2));
}
/**
 ...
 * ```
 */
function enableAdapterWithSignature(options) {
...
//# sourceMappingURL=enableAdapterWithSignature.js.map