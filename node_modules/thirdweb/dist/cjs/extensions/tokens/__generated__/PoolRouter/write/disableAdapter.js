...
exports.isDisableAdapterSupported = isDisableAdapterSupported;
exports.encodeDisableAdapterParams = encodeDisableAdapterParams;
exports.encodeDisableAdapter = encodeDisableAdapter;
exports.disableAdapter = disableAdapter;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0xa3f3a7bd";
const FN_INPUTS = [
    {
        type: "uint8",
        name: "adapterType",
 ...
 * ```
 */
function isDisableAdapterSupported(availableSelectors) {
 ...
 * ```
 */
function encodeDisableAdapterParams(options) {
 ...
 * ```
 */
function encodeDisableAdapter(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeDisableAdapterParams(options).slice(2));
}
/**
 ...
 * ```
 */
function disableAdapter(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.adapterType];
        },
...
//# sourceMappingURL=disableAdapter.js.map