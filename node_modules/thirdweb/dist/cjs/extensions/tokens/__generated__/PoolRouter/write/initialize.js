...
exports.FN_SELECTOR = "0x485cc955";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
...
function encodeInitializeParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.owner, options.manager]);
}
/**
...
function initialize(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.owner, resolvedOptions.manager];
        },
