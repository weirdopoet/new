...
exports.isGetRewardPositionsSupported = isGetRewardPositionsSupported;
exports.encodeGetRewardPositionsParams = encodeGetRewardPositionsParams;
exports.encodeGetRewardPositions = encodeGetRewardPositions;
exports.decodeGetRewardPositionsResult = decodeGetRewardPositionsResult;
exports.getRewardPositions = getRewardPositions;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xcb62c6b6";
const FN_INPUTS = [
    {
        type: "address",
        name: "asset",
 ...
 * ```
 */
function isGetRewardPositionsSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetRewardPositionsParams(options) {
 ...
 * ```
 */
function encodeGetRewardPositions(options) {
 ...
 * ```
 */
function decodeGetRewardPositionsResult(result) {
 ...
 * ```
 */
async function getRewardPositions(options) {
