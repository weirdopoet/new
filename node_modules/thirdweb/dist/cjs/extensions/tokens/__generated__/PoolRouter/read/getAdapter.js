...
exports.isGetAdapterSupported = isGetAdapterSupported;
exports.encodeGetAdapterParams = encodeGetAdapterParams;
exports.encodeGetAdapter = encodeGetAdapter;
exports.decodeGetAdapterResult = decodeGetAdapterResult;
exports.getAdapter = getAdapter;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xd6cbae4d";
const FN_INPUTS = [
    {
        type: "uint8",
        name: "adapterType",
 ...
 * ```
 */
function isGetAdapterSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetAdapterParams(options) {
 ...
 * ```
 */
function encodeGetAdapter(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeGetAdapterParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeGetAdapterResult(result) {
