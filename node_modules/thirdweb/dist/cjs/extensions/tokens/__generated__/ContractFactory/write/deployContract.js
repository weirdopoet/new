...
exports.isDeployContractSupported = isDeployContractSupported;
exports.encodeDeployContractParams = encodeDeployContractParams;
exports.encodeDeployContract = encodeDeployContract;
exports.deployContract = deployContract;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x8bc106dd";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "id",
 ...
 * ```
 */
function isDeployContractSupported(availableSelectors) {
 ...
 * ```
 */
function encodeDeployContractParams(options) {
 ...
 * ```
 */
function encodeDeployContract(options) {
