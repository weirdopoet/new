...
exports.isDomainSeparatorSupported = isDomainSeparatorSupported;
exports.decodeDomainSeparatorResult = decodeDomainSeparatorResult;
exports.domainSeparator = domainSeparator;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xf698da25";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
function isDomainSeparatorSupported(availableSelectors) {
 ...
 * ```
 */
function decodeDomainSeparatorResult(result) {
 ...
 * ```
 */
async function domainSeparator(options) {
