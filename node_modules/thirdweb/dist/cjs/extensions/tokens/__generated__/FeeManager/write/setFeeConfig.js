...
exports.isSetFeeConfigSupported = isSetFeeConfigSupported;
exports.encodeSetFeeConfigParams = encodeSetFeeConfigParams;
exports.encodeSetFeeConfig = encodeSetFeeConfig;
exports.setFeeConfig = setFeeConfig;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x636d2be9";
const FN_INPUTS = [
    {
        type: "bytes4",
        name: "action",
 ...
 * ```
 */
function isSetFeeConfigSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetFeeConfigParams(options) {
 ...
 * ```
 */
function encodeSetFeeConfig(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetFeeConfigParams(options).slice(2));
}
/**
...
//# sourceMappingURL=setFeeConfig.js.map