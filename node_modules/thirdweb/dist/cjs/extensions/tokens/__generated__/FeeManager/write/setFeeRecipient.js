...
exports.isSetFeeRecipientSupported = isSetFeeRecipientSupported;
exports.encodeSetFeeRecipientParams = encodeSetFeeRecipientParams;
exports.encodeSetFeeRecipient = encodeSetFeeRecipient;
exports.setFeeRecipient = setFeeRecipient;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0xe74b981b";
const FN_INPUTS = [
    {
        type: "address",
        name: "_feeRecipient",
 ...
 * ```
 */
function isSetFeeRecipientSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetFeeRecipientParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.feeRecipient]);
}
/**
 ...
 * ```
 */
function encodeSetFeeRecipient(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetFeeRecipientParams(options).slice(2));
}
/**
 ...
 * ```
 */
function setFeeRecipient(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.feeRecipient];
        },
...
//# sourceMappingURL=setFeeRecipient.js.map