...
exports.isCollectRewardSupported = isCollectRewardSupported;
exports.encodeCollectRewardParams = encodeCollectRewardParams;
exports.encodeCollectReward = encodeCollectReward;
exports.collectReward = collectReward;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x7bb87377";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
 ...
 * ```
 */
function isCollectRewardSupported(availableSelectors) {
 ...
 * ```
 */
function encodeCollectRewardParams(options) {
 ...
 * ```
 */
function encodeCollectReward(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeCollectRewardParams(options).slice(2));
}
/**
 ...
 * ```
 */
function collectReward(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.owner, resolvedOptions.asset];
        },
...
//# sourceMappingURL=collectReward.js.map