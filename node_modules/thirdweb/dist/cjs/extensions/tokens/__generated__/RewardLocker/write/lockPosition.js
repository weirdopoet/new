...
exports.isLockPositionSupported = isLockPositionSupported;
exports.encodeLockPositionParams = encodeLockPositionParams;
exports.encodeLockPosition = encodeLockPosition;
exports.lockPosition = lockPosition;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0xbe7506e8";
const FN_INPUTS = [
    {
        type: "address",
        name: "asset",
 ...
 * ```
 */
function isLockPositionSupported(availableSelectors) {
 ...
 * ```
 */
function encodeLockPositionParams(options) {
 ...
 * ```
 */
function encodeLockPosition(options) {
