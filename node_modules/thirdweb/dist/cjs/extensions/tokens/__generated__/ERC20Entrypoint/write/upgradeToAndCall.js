...
exports.isUpgradeToAndCallSupported = isUpgradeToAndCallSupported;
exports.encodeUpgradeToAndCallParams = encodeUpgradeToAndCallParams;
exports.encodeUpgradeToAndCall = encodeUpgradeToAndCall;
exports.upgradeToAndCall = upgradeToAndCall;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x4f1ef286";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isUpgradeToAndCallSupported(availableSelectors) {
 ...
 * ```
 */
function encodeUpgradeToAndCallParams(options) {
 ...
 * ```
 */
function encodeUpgradeToAndCall(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeUpgradeToAndCallParams(options).slice(2));
}
/**
 ...
 * ```
 */
function upgradeToAndCall(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.newImplementation, resolvedOptions.data];
        },
...
//# sourceMappingURL=upgradeToAndCall.js.map