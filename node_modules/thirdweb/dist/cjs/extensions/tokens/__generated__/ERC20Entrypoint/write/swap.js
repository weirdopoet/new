...
exports.isSwapSupported = isSwapSupported;
exports.encodeSwapParams = encodeSwapParams;
...
exports.FN_SELECTOR = "0x8892376c";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "params",
 ...
 * ```
 */
function isSwapSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSwapParams(options) {
