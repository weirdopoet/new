...
exports.isSetPoolRouterSupported = isSetPoolRouterSupported;
exports.encodeSetPoolRouterParams = encodeSetPoolRouterParams;
exports.encodeSetPoolRouter = encodeSetPoolRouter;
exports.setPoolRouter = setPoolRouter;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x0c8d9cc7";
const FN_INPUTS = [
    {
        type: "address",
        name: "poolRouter",
 ...
 * ```
 */
function isSetPoolRouterSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetPoolRouterParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.poolRouter]);
}
/**
 ...
 * ```
 */
function encodeSetPoolRouter(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetPoolRouterParams(options).slice(2));
}
/**
 ...
 * ```
 */
function setPoolRouter(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.poolRouter];
        },
...
//# sourceMappingURL=setPoolRouter.js.map