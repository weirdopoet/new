...
exports.isGetImplementationSupported = isGetImplementationSupported;
exports.encodeGetImplementationParams = encodeGetImplementationParams;
exports.encodeGetImplementation = encodeGetImplementation;
exports.decodeGetImplementationResult = decodeGetImplementationResult;
exports.getImplementation = getImplementation;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x3c2e0828";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "contractId",
 ...
 * ```
 */
function isGetImplementationSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetImplementationParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.contractId]);
}
/**
 ...
 * ```
 */
function encodeGetImplementation(options) {
 ...
 * ```
 */
function decodeGetImplementationResult(result) {
 ...
 * ```
 */
async function getImplementation(options) {
