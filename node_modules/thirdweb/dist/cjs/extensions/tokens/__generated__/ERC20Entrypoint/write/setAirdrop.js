...
exports.isSetAirdropSupported = isSetAirdropSupported;
exports.encodeSetAirdropParams = encodeSetAirdropParams;
exports.encodeSetAirdrop = encodeSetAirdrop;
exports.setAirdrop = setAirdrop;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x72820dbc";
const FN_INPUTS = [
    {
        type: "address",
        name: "airdrop",
 ...
 * ```
 */
function isSetAirdropSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetAirdropParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.airdrop]);
}
/**
 ...
 * ```
 */
function encodeSetAirdrop(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetAirdropParams(options).slice(2));
}
/**
...
function setAirdrop(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.airdrop];
        },
...
//# sourceMappingURL=setAirdrop.js.map