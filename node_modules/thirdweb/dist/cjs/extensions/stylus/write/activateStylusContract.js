...
exports.ARB_WASM_ADDRESS = void 0;
...
exports.ARB_WASM_ADDRESS = "0x0000000000000000000000000000000000000071";
/**
...
async function activateStylusContract(options) {
    ...
    const arbWasmPrecompile = (0, contract_js_1.getContract)({
        address: exports.ARB_WASM_ADDRESS,
        chain,
        client,
    });
