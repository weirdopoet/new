...
exports.isGetUriOfBundleSupported = isGetUriOfBundleSupported;
exports.encodeGetUriOfBundleParams = encodeGetUriOfBundleParams;
exports.encodeGetUriOfBundle = encodeGetUriOfBundle;
exports.decodeGetUriOfBundleResult = decodeGetUriOfBundleResult;
exports.getUriOfBundle = getUriOfBundle;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x61195e94";
const FN_INPUTS = [
    {
        name: "_bundleId",
        type: "uint256",
 ...
 * ```
 */
function isGetUriOfBundleSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetUriOfBundleParams(options) {
 ...
 * ```
 */
function encodeGetUriOfBundle(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeGetUriOfBundleParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeGetUriOfBundleResult(result) {
 ...
 * ```
 */
async function getUriOfBundle(options) {
...
//# sourceMappingURL=getUriOfBundle.js.map