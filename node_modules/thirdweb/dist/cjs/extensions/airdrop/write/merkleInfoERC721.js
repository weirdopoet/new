...
exports.generateMerkleTreeInfoERC721 = generateMerkleTreeInfoERC721;
const process_snapshot_erc721_js_1 = require("../../../utils/extensions/airdrop/process-snapshot-erc721.js");
/**
 ...
 */
async function generateMerkleTreeInfoERC721(options) {
    const { snapshot, contract } = options;
    // generate merkle tree from snapshot
    const { shardedMerkleInfo, uri } = await (0, process_snapshot_erc721_js_1.processSnapshotERC721)({
...
//# sourceMappingURL=merkleInfoERC721.js.map