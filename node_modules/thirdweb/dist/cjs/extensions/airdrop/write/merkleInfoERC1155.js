...
exports.generateMerkleTreeInfoERC1155 = generateMerkleTreeInfoERC1155;
const process_snapshot_erc1155_js_1 = require("../../../utils/extensions/airdrop/process-snapshot-erc1155.js");
/**
 ...
 */
async function generateMerkleTreeInfoERC1155(options) {
    const { snapshot, contract } = options;
    // generate merkle tree from snapshot
    const { shardedMerkleInfo, uri } = await (0, process_snapshot_erc1155_js_1.processSnapshotERC1155)({
...
//# sourceMappingURL=merkleInfoERC1155.js.map