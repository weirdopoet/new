...
const setClaimCondition_js_1 = require("../__generated__/ClaimableERC721/write/setClaimCondition.js");
/**
        ...
        asyncParams: async () => {
            ...
            return {
                claimCondition: {
                    ...
                    maxMintPerWallet,
                    pricePerUnit,
                    startTimestamp: Number((0, date_js_1.dateToSeconds)(startTime)), // stores the merkle root and merkle tree uri in IPFS
                },
            };
        },
