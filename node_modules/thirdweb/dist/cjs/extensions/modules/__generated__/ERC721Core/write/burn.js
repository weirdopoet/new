...
exports.FN_SELECTOR = "0xfe9d9303";
const FN_INPUTS = [
    {
        name: "tokenId",
        type: "uint256",
...
function encodeBurnParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.tokenId, options.data]);
}
/**
...
function burn(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.tokenId, resolvedOptions.data];
        },
