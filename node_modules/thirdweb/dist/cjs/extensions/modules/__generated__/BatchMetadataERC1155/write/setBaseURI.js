...
exports.isSetBaseURISupported = isSetBaseURISupported;
exports.encodeSetBaseURIParams = encodeSetBaseURIParams;
exports.encodeSetBaseURI = encodeSetBaseURI;
exports.setBaseURI = setBaseURI;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
exports.FN_SELECTOR = "0x33cfcb9f";
const FN_INPUTS = [
    {
        name: "_batchIndex",
        type: "uint256",
 ...
 * ```
 */
function isSetBaseURISupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetBaseURIParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.batchIndex, options.baseURI]);
}
/**
 ...
 * ```
 */
function encodeSetBaseURI(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetBaseURIParams(options).slice(2));
}
/**
...
function setBaseURI(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.batchIndex, resolvedOptions.baseURI];
        },
        value: async () => (await asyncOptions()).overrides?.value,
    });
}
//# sourceMappingURL=setBaseURI.js.map