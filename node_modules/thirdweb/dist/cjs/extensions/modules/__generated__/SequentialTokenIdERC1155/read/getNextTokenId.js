...
exports.isGetNextTokenIdSupported = isGetNextTokenIdSupported;
exports.decodeGetNextTokenIdResult = decodeGetNextTokenIdResult;
exports.getNextTokenId = getNextTokenId;
const viem_1 = require("viem");
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xcaa0f92a";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isGetNextTokenIdSupported(availableSelectors) {
 ...
 * ```
 */
function decodeGetNextTokenIdResult(result) {
 ...
 * ```
 */
async function getNextTokenId(options) {
...
//# sourceMappingURL=getNextTokenId.js.map