...
function encodeStateOverrides(overrides) {
    return Object.fromEntries(Object.entries(overrides).map(([address, override]) => {
        return [
            address,
            {
                balance: override.balance ? (0, hex_js_1.numberToHex)(override.balance) : undefined,
                code: override.code,
                nonce: override.nonce ? (0, hex_js_1.numberToHex)(override.nonce) : undefined,
...
async function eth_call(request, params) {
    ...
    const blockNumberHex = blockNumber ? (0, hex_js_1.numberToHex)(blockNumber) : undefined;
