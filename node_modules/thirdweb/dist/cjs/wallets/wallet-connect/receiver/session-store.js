...
function initializeSessionStore(options) {
    if (!exports.walletConnectSessions) {
        exports.walletConnectSessions = new client_scoped_storage_js_1.ClientScopedStorage({
...
async function saveSession(session) {
    ...
    await exports.walletConnectSessions.saveWalletConnectSessions((0, json_js_1.stringify)(sessions));
}
/**
 * @internal
 */
async function removeSession(session) {
    ...
    await exports.walletConnectSessions.saveWalletConnectSessions((0, json_js_1.stringify)(newSessions));
}
/**
