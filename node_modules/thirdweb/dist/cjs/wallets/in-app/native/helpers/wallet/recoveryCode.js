...
async function getCognitoRecoveryPasswordV1(args) {
    const idTokenResponse = await (0, fetchers_js_1.authFetchEmbeddedWalletUser)({
        ...
        url: constants_js_1.ROUTE_AUTH_COGNITO_ID_TOKEN_V1,
    });
    ...
    const params = {
        ...
        Payload: (0, to_bytes_js_1.stringToBytes)((0, json_js_1.stringify)({
            accessToken,
            idToken,
        })),
    };
...
async function getCognitoRecoveryPasswordV2(args) {
    const idTokenResponse = await (0, fetchers_js_1.authFetchEmbeddedWalletUser)({
        client: args.client,
        props: {
            method: "GET",
