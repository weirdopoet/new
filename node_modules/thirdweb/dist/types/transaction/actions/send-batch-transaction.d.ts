 ...
 * ```
 */
export declare function sendBatchTransaction(options: SendBatchTransactionOptions): Promise<WaitForReceiptOptions>;
//# sourceMappingURL=send-batch-transaction.d.ts.map