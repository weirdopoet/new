 ...
 */
export declare const IframePlayer: React.ForwardRefExoticComponent<Omit<MediaRendererProps, "client" | "height" | "width" | "children" | "controls" | "gatewayUrl" | "mimeType"> & React.RefAttributes<HTMLIFrameElement>>;
/**
 * @internal Exported for tests
 */
export declare const LinkPlayer: React.ForwardRefExoticComponent<Pick<MediaRendererProps, "style" | "src" | "alt" | "className"> & React.RefAttributes<HTMLAnchorElement>>;
/**
 * @internal
 */
