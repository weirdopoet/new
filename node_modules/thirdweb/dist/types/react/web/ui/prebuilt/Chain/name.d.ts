 ...
 * @beta
 */
export declare function ChainName({ nameResolver, formatFn, loadingComponent, fallbackComponent, queryOptions, ...restProps }: ChainNameProps): import("react/jsx-runtime").JSX.Element | null;
/**
