 ...
 * @beta
 */
export declare function TokenName({ nameResolver, formatFn, loadingComponent, fallbackComponent, queryOptions, ...restProps }: TokenNameProps): import("react/jsx-runtime").JSX.Element | null;
/**
 * @internal Exported for tests only
 */
export declare function fetchTokenName(props: {
    address: string;
...
export declare function getQueryKeys(props: {
    ...
    address: string;
    nameResolver?: string | (() => string) | (() => Promise<string>);
}): readonly ["_internal_token_name_", number, string, {
