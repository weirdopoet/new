 ...
 * @beta
 */
export declare function NFTDescription({ loadingComponent, fallbackComponent, queryOptions, descriptionResolver, ...restProps }: NFTDescriptionProps): import("react/jsx-runtime").JSX.Element | null;
/**
