 ...
 * @beta
 */
export declare function TokenIcon({ iconResolver, loadingComponent, fallbackComponent, queryOptions, ...restProps }: TokenIconProps): import("react/jsx-runtime").JSX.Element | null;
