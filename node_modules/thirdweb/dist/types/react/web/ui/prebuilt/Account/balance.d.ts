...
export interface AccountBalanceProps extends Omit<React.HTMLAttributes<HTMLSpanElement>, "children"> {
     ...
     */
    queryOptions?: Omit<UseQueryOptions<AccountBalanceInfo>, "queryFn" | "queryKey">;
    /**
 ...
 * @beta
 */
export declare function AccountBalance({ chain, tokenAddress, loadingComponent, fallbackComponent, queryOptions, formatFn, showBalanceInFiat, ...restProps }: AccountBalanceProps): import("react/jsx-runtime").JSX.Element | null;
