 ...
 * @beta
 */
export declare function NFTName({ loadingComponent, fallbackComponent, queryOptions, nameResolver, ...restProps }: NFTNameProps): import("react/jsx-runtime").JSX.Element | null;
/**
 * @internal
 */
