 ...
 * @beta
 */
export declare function ChainIcon({ iconResolver, loadingComponent, fallbackComponent, queryOptions, client, ...restProps }: ChainIconProps): import("react/jsx-runtime").JSX.Element | null;
/**
 * @internal Exported for tests only
 */
export declare function fetchChainIcon(props: {
    chain: Chain;
    client: ThirdwebClient;
    iconResolver?: string | (() => string) | (() => Promise<string>);
}): Promise<string>;
...
export declare function getQueryKeys(props: {
    chainId: number;
    iconResolver?: string | (() => string) | (() => Promise<string>);
}): readonly ["_internal_chain_icon_", number, {
