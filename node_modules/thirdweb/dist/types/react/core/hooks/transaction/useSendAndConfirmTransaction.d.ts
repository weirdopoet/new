 ...
 * @transaction
 */
export declare function useSendAndConfirmTransactionCore(config?: SendAndConfirmTransactionConfig): UseMutationResult<TransactionReceipt, Error, SendTransactionOptions["transaction"]>;
export {};
