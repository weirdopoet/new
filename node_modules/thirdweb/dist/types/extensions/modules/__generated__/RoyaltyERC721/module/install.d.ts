...
import { type EncodeBytesOnInstallParams } from "../encode/encodeBytesOnInstall.js";
/**
 ...
 */
export declare function module(params: EncodeBytesOnInstallParams & {
    publisher?: string;
}): (args: {
 ...
 * @modules RoyaltyERC721
 */
export declare function encodeInstall(params: EncodeBytesOnInstallParams): `0x${string}`;
