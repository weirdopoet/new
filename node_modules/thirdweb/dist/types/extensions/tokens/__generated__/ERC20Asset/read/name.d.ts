 ...
 * @example
 * ```ts
 * import { isNameSupported } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { decodeNameResult } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { name } from "thirdweb/extensions/tokens";
 *
