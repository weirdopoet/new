 ...
 * @example
 * ```ts
 * import { isNoncesSupported } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodeNoncesParams } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { encodeNonces } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { decodeNoncesResult } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { nonces } from "thirdweb/extensions/tokens";
 *
