 ...
 * @example
 * ```ts
 * import { isDOMAIN_SEPARATORSupported } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { decodeDOMAIN_SEPARATORResult } from "thirdweb/extensions/tokens";
 ...
 * @example
 * ```ts
 * import { DOMAIN_SEPARATOR } from "thirdweb/extensions/tokens";
 *
