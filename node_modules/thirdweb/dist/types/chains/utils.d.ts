 ...
 */
export declare const CUSTOM_CHAIN_MAP: Map<number, Readonly<ChainOptions & {
    rpc: string;
}>>;
/**
 ...
 * @internal
 */
export declare function convertLegacyChain(legacyChain: LegacyChain): Chain;
/**
 * @internal
 */
export declare function convertViemChain(viemChain: ViemChain): Chain;
...
export declare function getInsightEnabledChainIds(): Promise<number[]>;
/**
