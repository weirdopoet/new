...
export declare const ethers5Adapter: {
    ...
    contract: {
         ...
         * ```
         */
        fromEthers: (options: FromEthersContractOptions) => Promise<Readonly<import("../contract/contract.js").ContractOptions<Abi, `0x${string}`>>>;
        /**
    ...
    signer: {
        ...
        toEthers: (options: {
            ...
            readonly provider?: ethers5.ethers.providers.Provider;
            readonly _isSigner: boolean;
            getBalance(blockTag?: ethers5.ethers.providers.BlockTag): Promise<ethers5.ethers.BigNumber>;
            getTransactionCount(blockTag?: ethers5.ethers.providers.BlockTag): Promise<number>;
            ...
            call(transaction: ethers5.ethers.utils.Deferrable<ethers5.ethers.providers.TransactionRequest>, blockTag?: ethers5.ethers.providers.BlockTag): Promise<string>;
 ...
 * @internal
 */
export declare function toEthersProvider(ethers: Ethers5, client: ThirdwebClient, chain: Chain): ethers5.providers.Provider;
/**
 * Converts a ThirdwebContract to an ethers.js Contract.
 ...
 * @internal
 */
export declare function toEthersContract<abi extends Abi = []>(ethers: Ethers5, twContract: ThirdwebContract<abi>): Promise<ethers5.Contract>;
 ...
 * @internal
 */
export declare function fromEthersContract<abi extends Abi>(options: FromEthersContractOptions): Promise<ThirdwebContract<abi>>;
/**
 ...
 * @internal
 */
export declare function fromEthersSigner(signer: ethers5.Signer): Promise<Account>;
/**
 * @internal
 */
